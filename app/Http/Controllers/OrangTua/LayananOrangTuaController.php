...
class LayananOrangTuaController extends Controller
{
    public function index()
    {
        $tickets = Layanan::with('replies')->where('user_id', auth()->id())->orderBy('updated_at', 'desc')->get();
        return view('orang-tua.layanan.daftar', compact('tickets'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('ortu.layanan.index')->with('success', 'Tiket berhasil dibuat.');
    }
    ...
    public function show($id)
    {
        ...
        return view('orang-tua.layanan.detail', compact('ticket'));
    }
