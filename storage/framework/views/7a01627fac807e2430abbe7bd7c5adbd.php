...
<?php $__env->startSection('title', 'Detail Jadwal: ' . $schedule->nama_kelas); ?>

<?php $__env->startSection('breadcrumbs'); ?>
    <svg class="w-3 h-3 mx-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
    <a href="<?php echo e(route('admin.class-schedules.index')); ?>" class="hover:text-primary-600 transition-colors">Jadwal Kelas</a>
    <svg class="w-3 h-3 mx-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.tajuk-halaman','data' => ['title' => 'Detail Jadwal Kelas','backUrl' => 'javascript:history.back()']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Detail Jadwal Kelas','backUrl' => 'javascript:history.back()']); ?>
             <?php $__env->slot('rightActions', null, []); ?> 
                <div class="flex space-x-3">
                    ...
                    <form action="<?php echo e(route('admin.class-schedules.destroy', $schedule->id)); ?>" method="POST" class="delete-form" data-name="Jadwal Kelas <?php echo e($schedule->nama_kelas); ?>">
                        <?php echo csrf_field(); ?>
        ...
        <div class="flex flex-col md:flex-row items-center md:items-start gap-6 relative z-10">
            ...
            <div class="flex-grow text-center md:text-left w-full">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h2 class="text-2xl md:text-3xl font-extrabold text-primary-600"><?php echo e($schedule->nama_kelas); ?></h2>
                        <p class="text-gray-900 font-bold text-lg mt-1"><?php echo e($schedule->hari); ?>, <?php echo e($schedule->formatted_time_range); ?></p>
                    </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.antarmuka.lencana','data' => ['color' => 'primary','class' => 'inline-flex items-center px-3 py-1 rounded-full text-sm font-bold border w-fit']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'primary','class' => 'inline-flex items-center px-3 py-1 rounded-full text-sm font-bold border w-fit']); ?>
                                <span class="w-2 h-2 rounded-full bg-primary-500 mr-2 animate-pulse"> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?> Kelas Aktif
                            </span>
                        <?php else: ?>
                            <?php if (isset($component)) { $__componentOriginal9e0c80b3c4e03c7346eb73cf95f43f4b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9e0c80b3c4e03c7346eb73cf95f43f4b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.antarmuka.lencana','data' => ['color' => 'gray','class' => 'inline-flex items-center px-3 py-1 rounded-full text-sm font-bold border w-fit']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('antarmuka.lencana'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'gray','class' => 'inline-flex items-center px-3 py-1 rounded-full text-sm font-bold border w-fit']); ?>
                                <span class="w-2 h-2 rounded-full bg-gray-500 mr-2"> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9e0c80b3c4e03c7346eb73cf95f43f4b)): ?>
<?php $attributes = $__attributesOriginal9e0c80b3c4e03c7346eb73cf95f43f4b; ?>
<?php unset($__attributesOriginal9e0c80b3c4e03c7346eb73cf95f43f4b); ?>
                    ...
                    <div class="inline-flex items-center text-sm font-medium text-gray-600">
                        ...
                        <?php if($schedule->package): ?>
                            <div class="flex items-center flex-wrap gap-2">
                                <a href="<?php echo e(route('admin.packages.show', $schedule->program_id)); ?>" class="font-bold text-gray-800 hover:text-primary-600 transition-colors decoration-gray-300 hover:decoration-primary-500 underline-offset-4">
                                    <?php echo e($schedule->package->nama_program); ?>
                    ...
                    <div class="inline-flex items-center text-sm font-medium text-gray-600">
                        ...
                        <span class="font-bold text-gray-800 flex items-center">
                            ...
                            <?php if($schedule->mentor): ?>
                                <a href="<?php echo e(route('admin.mentor.show', $schedule->mentor->user_id)); ?>" class="hover:text-primary-600 transition-colors decoration-primary-300 hover:decoration-primary-500 underline-offset-4">
                                    <?php echo e($schedule->mentor->name); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'primary']); ?><?php echo e($schedule->students->count()); ?> Murid <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9e0c80b3c4e03c7346eb73cf95f43f4b)): ?>
<?php $attributes = $__attributesOriginal9e0c80b3c4e03c7346eb73cf95f43f4b; ?>
<?php unset($__attributesOriginal9e0c80b3c4e03c7346eb73cf95f43f4b); ?>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse text-sm">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <?php $__empty_1 = true; $__currentLoopData = $schedule->students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-primary-50/50 transition-colors">
                                <td class="px-6 py-5 text-sm font-bold text-gray-900 text-center"><?php echo e($index + 1); ?></td>
                                <td class="px-6 py-5">
                                    <a href="<?php echo e(route('admin.students.show', $student->id)); ?>" class="font-semibold text-primary-700 text-base mb-1 hover:text-primary-600 transition-colors block underline decoration-primary-300 hover:decoration-primary-500 underline-offset-4"><?php echo e($student->nama_murid); ?></a>
                                    <p class="text-xs text-gray-500 mt-1">Orang Tua: <?php echo e($student->user->name ?? '-'); ?></p>
                                </td>
                                <td class="px-6 py-5 text-sm font-semibold text-gray-900 text-center"><?php echo e($student->kelas ?? '-'); ?> SD</td>
                                <td class="px-6 py-5 text-sm font-semibold text-gray-900"><?php echo e($student->sekolah ?? '-'); ?></td>
                                <td class="px-6 py-5 text-sm font-semibold text-gray-900"><?php echo e($student->pivot->created_at ? $student->pivot->created_at->format('d M Y') : '-'); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.formulir-hapus','data' => ['route' => route('admin.class-schedules.remove-student', ['id' => $schedule->id, 'murid_id' => $student->id]),'title' => 'Keluarkan Murid?','text' => 'Apakah Anda yakin ingin mengeluarkan '.e($student->panggilan_murid ?? $student->nama_murid).' dari kelas ini? Murid tidak akan dihapus dari sistem, hanya dikeluarkan dari jadwal ini.','confirm' => 'Ya, Keluarkan Murid']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.class-schedules.remove-student', ['id' => $schedule->id, 'murid_id' => $student->id])),'title' => 'Keluarkan Murid?','text' => 'Apakah Anda yakin ingin mengeluarkan '.e($student->panggilan_murid ?? $student->nama_murid).' dari kelas ini? Murid tidak akan dihapus dari sistem, hanya dikeluarkan dari jadwal ini.','confirm' => 'Ya, Keluarkan Murid']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.keadaan-kosong','data' => ['icon' => 'users','title' => 'Daftar Murid Kosong','message' => 'Belum ada murid yang didaftarkan di kelas ini.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'users','title' => 'Daftar Murid Kosong','message' => 'Belum ada murid yang didaftarkan di kelas ini.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div class="lg:col-span-1 space-y-4">
            ...
            ?>
            <div class="bg-gradient-to-br <?php echo e($isFull ? 'from-red-600 to-red-800 border-red-500' : 'from-primary-600 to-primary-800 border-primary-500'); ?> rounded-2xl shadow-md border p-5 text-white relative overflow-hidden">
                <div class="relative z-10 flex flex-col">
                    ...
                    <div class="text-4xl font-extrabold flex items-baseline gap-1">
                        <?php echo e($schedule->jumlah_murid); ?> <span class="text-lg font-medium text-white/70">/ <?php echo e($maxCapacity); ?> Murid</span>
                    </div>

                    <div class="mt-5 w-full bg-black/20 rounded-full h-2 overflow-hidden border border-white/10">
                        <div class="bg-white h-2 rounded-full transition-all duration-500" style="width: <?php echo e($percentage); ?>%"></div>
                    </div>
                    <div class="mt-2 text-xs font-medium text-white/80 text-right">
                        <?php echo e($isFull ? 'Kelas Penuh' : ($maxCapacity - $schedule->jumlah_murid) . ' Kursi Tersedia'); ?>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-primary-100/50 p-5">
                ...
                <div class="space-y-3">
                    <a href="<?php echo e(route('admin.attendances.index', ['jadwal_id' => $schedule->id])); ?>" class="flex items-center p-3 rounded-xl border border-gray-200 hover:border-primary-300 hover:bg-primary-50 transition-colors group">
                    ...
                    <a href="<?php echo e(route('admin.progress-notes.index', ['jadwal_id' => $schedule->id])); ?>" class="flex items-center p-3 rounded-xl border border-gray-200 hover:border-primary-300 hover:bg-primary-50 transition-colors group">
                    ...
                    <a href="<?php echo e(route('admin.scores.index', ['jadwal_id' => $schedule->id])); ?>" class="flex items-center p-3 rounded-xl border border-gray-200 hover:border-primary-300 hover:bg-primary-50 transition-colors group">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-primary-100/50 p-5">
                ...
                <dl class="space-y-4 text-sm">
                    <div>
                        ...
                        <dd class="text-sm font-semibold text-gray-900"><?php echo e($schedule->created_at ? $schedule->created_at->format('d M Y, H:i') : '-'); ?></dd>
                    </div>
                    <div>
                        <dt class="block text-xs text-gray-600 font-semibold uppercase tracking-wider mb-1">Terakhir Diperbarui</dt>
                        <dd class="text-sm font-semibold text-gray-900"><?php echo e($schedule->updated_at ? $schedule->updated_at->format('d M Y, H:i') : '-'); ?></dd>
                    </div>
                </dl>
            </div>
...
<div x-data="{ open: false }"
    ...
    <div x-show="open"
        ...
        <form action="<?php echo e(route('admin.class-schedules.add-student', $schedule->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="mb-5">
                ...
                <select name="murid_id" id="murid_id" class="searchable-select w-full" data-placeholder="Cari nama murid..." required>
                    ...
                    <?php $__currentLoopData = $availableStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($student->id); ?>"><?php echo e($student->nama_murid); ?> (<?php echo e($student->kelas ?? '-'); ?> SD) - <?php echo e($student->sekolah ?? '-'); ?></option>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ruang-les\resources\views/admin/jadwal-kelas/detail.blade.php ENDPATH**/ ?>