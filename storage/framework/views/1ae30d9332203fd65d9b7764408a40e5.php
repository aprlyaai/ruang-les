            ...
            <div class="mt-5 border-t border-gray-100 pt-5 grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
                ...
                <div class="md:col-span-7 flex flex-col gap-2.5">
                    <div class="flex items-start text-sm">
                        <div class="w-32 sm:w-36 shrink-0 text-gray-500 font-semibold flex items-center pr-2">
                    ...
                    <div class="flex items-start text-sm">
                        <div class="w-32 sm:w-36 shrink-0 text-gray-500 font-semibold flex items-center pr-2">
                            <svg class="w-4 h-4 mr-1.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                            Kelas Belajar
                        </div>
                        <div class="flex flex-col gap-1 flex-1 break-words">
                            <?php if(isset($jadwals) && $jadwals->count() > 0): ?>
