...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.tajuk-halaman','data' => ['title' => 'Profil Saya','description' => 'Kelola data pribadi dan kata sandi Anda.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Profil Saya','description' => 'Kelola data pribadi dan kata sandi Anda.']); ?>
...
<?php endif; ?>
    ...
    <!-- Form -->
    <form action="<?php echo e(route('ortu.profile.update')); ?>" method="POST" enctype="multipart/form-data"
          x-data="{
              ...
              phoneNumber: <?php echo \Illuminate\Support\Js::from((string) old('nomor_telepon', $user->parentProfile->no_telepon_orangtua ?? ''))->toHtml() ?>,
              showPassword: false,
              showPasswordConfirm: false,
              password: '',
              statusHubungan: <?php echo \Illuminate\Support\Js::from((string) old('status_hubungan', $user->parentProfile->status_hubungan ?? ''))->toHtml() ?>,
              alamatDomisili: <?php echo \Illuminate\Support\Js::from((string) old('alamat_domisili', $user->parentProfile->alamat_domisili ?? ''))->toHtml() ?>,
              imagePreview: <?php echo \Illuminate\Support\Js::from($user->avatar ? asset('storage/' . $user->avatar) : '')->toHtml() ?>,
              touched: {},
              ...
              resetForm() {
                  this.name = <?php echo \Illuminate\Support\Js::from((string) old('name', $user->name ?? ''))->toHtml() ?>;
                  this.email = <?php echo \Illuminate\Support\Js::from((string) old('email', $user->email ?? ''))->toHtml() ?>;
                  this.phoneNumber = <?php echo \Illuminate\Support\Js::from((string) old('nomor_telepon', $user->parentProfile->no_telepon_orangtua ?? ''))->toHtml() ?>;
                  this.password = '';
                  this.showPassword = false;
                  this.showPasswordConfirm = false;
                  this.statusHubungan = <?php echo \Illuminate\Support\Js::from((string) old('status_hubungan', $user->parentProfile->status_hubungan ?? ''))->toHtml() ?>;
                  this.alamatDomisili = <?php echo \Illuminate\Support\Js::from((string) old('alamat_domisili', $user->parentProfile->alamat_domisili ?? ''))->toHtml() ?>;
                  this.imagePreview = <?php echo \Illuminate\Support\Js::from($user->avatar ? asset('storage/' . $user->avatar) : '')->toHtml() ?>;
                  this.touched = {};
...
<?php echo $__env->make('layouts.orang-tua', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ruang-les\resources\views/orang-tua/profil/utama.blade.php ENDPATH**/ ?>