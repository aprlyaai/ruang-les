<?php $__env->startSection('title', 'Kelola Fitur Unggulan'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.tajuk-halaman','data' => ['title' => 'Fitur Unggulan','description' => 'Tampilkan apa saja yang bikin bimbelmu spesial dan beda dari yang lain!','actionUrl' => ''.e(route('admin.features.create')).'','actionLabel' => 'Tambah Fitur']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Fitur Unggulan','description' => 'Tampilkan apa saja yang bikin bimbelmu spesial dan beda dari yang lain!','actionUrl' => ''.e(route('admin.features.create')).'','actionLabel' => 'Tambah Fitur']); ?>
            ...
            <table class="w-full text-left border-collapse text-sm">
                ...
                <tbody id="sortable-table" class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="bg-white hover:bg-gray-50 transition-colors" data-id="<?php echo e($feature->id); ?>">
                            ...
                            <td class="px-4 py-4 align-middle">
                                <div class="text-sm font-bold text-gray-900"><?php echo e($feature->nama_keunggulan); ?></div>
                            </td>
                            <td class="px-4 py-4 align-middle">
                                <div class="text-sm text-gray-900 max-w-3xl leading-relaxed text-justify"><?php echo e($feature->deskripsi_keunggulan); ?></div>
                            </td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.sakelar-status','data' => ['route' => route('admin.features.toggle-status', $feature->id),'isActive' => $feature->status_keunggulan]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.features.toggle-status', $feature->id)),'is-active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($feature->status_keunggulan)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            ...
                            <td class="px-4 py-3 align-middle">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="<?php echo e(route('admin.features.edit', $feature->id)); ?>" class="inline-flex items-center p-2 text-sm font-medium text-gray-500 bg-gray-50 rounded-lg hover:bg-gray-100 hover:text-primary-600 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500" title="Edit">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.formulir-hapus','data' => ['route' => route('admin.features.destroy', $feature->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.features.destroy', $feature->id))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.keadaan-kosong','data' => ['title' => 'Belum Ada Fitur','message' => 'Belum ada fitur unggulan yang ditambahkan untuk ditampilkan di halaman publik.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Belum Ada Fitur','message' => 'Belum ada fitur unggulan yang ditambahkan untuk ditampilkan di halaman publik.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
    ...
    if (el) {
        var sortable = Sortable.create(el, {
            ...
            onEnd: function(evt) {
                ...
                if(orders.length > 0) {
                    fetch('<?php echo e(route('admin.features.reorder')); ?>', {
                        method: 'POST',
                        headers: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ruang-les\resources\views/admin/keunggulan/daftar.blade.php ENDPATH**/ ?>