        ...
        <div class="relative z-10 w-full max-w-md mx-auto">
            ...
            <div class="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-[0_8px_30px_rgb(239,68,68,0.15)] border border-white/50 p-8 sm:p-10 text-center transform transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_50px_rgb(239,68,68,0.25)]">
                ...
                <p class="text-gray-600 mb-6 text-sm leading-relaxed">
                    Halo <span class="font-bold text-gray-900"><?php echo e($user->name); ?></span>, sistem mendeteksi Anda masuk sebagai <span class="uppercase font-bold text-red-600 bg-red-50 px-2 py-0.5 rounded"><?php echo e($user->role); ?></span>. 
                </p>
                ...
                <?php if($user->role === 'admin'): ?>
                    <a href="<?php echo e(url('/admin/dashboard')); ?>" class="w-full flex items-center justify-center py-4 px-6 border border-transparent rounded-full shadow-lg text-sm font-bold text-white bg-gray-900 hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-300 transition-all transform hover:-translate-y-1 group">
                ...
                <?php elseif($user->role === 'mentor'): ?>
                    <a href="<?php echo e(url('/mentor/dashboard')); ?>" class="w-full flex items-center justify-center py-4 px-6 border border-transparent rounded-full shadow-lg text-sm font-bold text-white bg-gray-900 hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-300 transition-all transform hover:-translate-y-1 group">
                        Kembali ke Dashboard Mentor
                        <svg class="w-5 h-5 ml-2 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(url('/')); ?>" class="w-full flex items-center justify-center py-4 px-6 border border-transparent rounded-full shadow-lg text-sm font-bold text-white bg-gray-900 hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-gray-300 transition-all transform hover:-translate-y-1 group">
                        Kembali ke Beranda
                        <svg class="w-5 h-5 ml-2 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                    </a>
                <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\ruang-les\resources\views/publik/akses-ditolak.blade.php ENDPATH**/ ?>