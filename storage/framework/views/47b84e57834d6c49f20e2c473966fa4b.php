<header class="h-20 bg-white/80 backdrop-blur-md border border-primary-100/50 rounded-2xl flex items-center justify-between px-6 shadow-sm relative z-20">
    <div class="flex items-center">
        ...
        <div class="hidden sm:flex items-center text-sm font-medium text-gray-500">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="hover:text-primary-600 transition-colors">Home</a>
        ...
        <div x-data="{ dropdownOpen: false }" class="relative">
            <button @click="dropdownOpen = !dropdownOpen" class="flex items-center space-x-3 focus:outline-none px-3 py-2 rounded-xl hover:bg-white transition-colors border border-transparent hover:border-gray-100 hover:shadow-sm">
                <div class="hidden md:flex flex-col items-end text-right">
                    ...
                    <span class="text-xs font-bold text-primary-600 mt-1">Admin</span>
                </div>
            ...
            <div x-show="dropdownOpen" 
                ...
                <a href="<?php echo e(route('admin.profile.index')); ?>" class="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 hover:text-primary-600 font-medium transition-colors group">
...
<?php /**PATH C:\laragon\www\ruang-les\resources\views/components/admin/tajuk.blade.php ENDPATH**/ ?>