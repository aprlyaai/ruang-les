    ...
    <div class="bg-white/60 backdrop-blur-md border border-white/50 rounded-2xl p-5 md:p-6 shadow-sm relative overflow-hidden transition-all duration-300 hover:shadow-md hover:bg-white/80">
        ...
        <div class="flex flex-col md:flex-row gap-6 justify-between items-start">
            ...
            <div class="flex-1 w-full">
                ...
                <p class="text-sm font-medium text-gray-600 mb-3">Total tagihan untuk paket pilihan Anda <strong class="text-gray-900 font-bold"><?php echo e($selectedPaket ? ($selectedPaket->nama_program ?? $selectedPaket->nama_program) : ''); ?></strong>:</p>
                ...
                <div class="inline-block bg-gradient-to-br from-primary-600 to-primary-800 rounded-2xl px-6 py-5 shadow-lg relative overflow-hidden group">
                    ...
                    <p class="text-4xl font-black text-white tracking-tight relative z-10">
                        Rp <?php echo e($selectedPaket ? number_format($selectedPaket->harga ?? $selectedPaket->harga, 0, ',', '.') : '0'); ?>
                ...
                <div class="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-5 md:p-6 text-white shadow-xl relative overflow-hidden group">
                    ...
                    <div class="relative z-10">
                        <div class="flex justify-between items-center mb-5">
                            <span class="text-2xl font-black tracking-widest text-gray-100 italic"><?php echo e($settings['nama_bank'] ?? 'Bank Central Asia (BCA)'); ?></span>
                        ...
                        <div class="mb-3 flex justify-between items-end">
                            <div>
                                ...
                                <div class="flex items-center gap-3">
                                    <span id="rekening-number" class="font-mono text-2xl md:text-3xl tracking-[0.15em] font-medium text-white shadow-sm"><?php echo e($settings['nomor_akun_bank'] ?? '7340033447'); ?></span>
                        ...
                        <div>
                            ...
                            <span class="font-bold tracking-widest text-sm uppercase text-gray-100"><?php echo e($settings['nama_akun_bank'] ?? 'ISMATURROHMAH'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.antarmuka.unggah-berkas','data' => ['name' => 'bukti_bayar','xShowError' => ''.e($errors->has('bukti_bayar') ? 'true' : 'false').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'bukti_bayar','x-show-error' => ''.e($errors->has('bukti_bayar') ? 'true' : 'false').'']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.antarmuka.galat-sebaris','data' => ['name' => 'bukti_bayar']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'bukti_bayar']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\laragon\www\ruang-les\resources\views/pendaftaran/langkah7-pembayaran.blade.php ENDPATH**/ ?>