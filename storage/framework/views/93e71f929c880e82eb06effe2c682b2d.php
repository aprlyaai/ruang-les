...
<?php endif; ?>
        ...
        <div x-data="{
            ...
            <button @click="scrollToSlide(activeSlide - 1)"
                    ...
                    class="hidden md:flex absolute -left-4 lg:-left-6 top-[40%] -translate-y-1/2 z-20 w-12 h-12 rounded-full border-2 bg-white/90 backdrop-blur items-center justify-center transition-all duration-300 shadow-xl focus:outline-none">
            ...
            <button @click="scrollToSlide(activeSlide + 1)"
                    ...
                    class="hidden md:flex absolute -right-4 lg:-right-6 top-[40%] -translate-y-1/2 z-20 w-12 h-12 rounded-full border-2 bg-white/90 backdrop-blur items-center justify-center transition-all duration-300 shadow-xl focus:outline-none">
