            ...
            <label class="group relative bg-white/60 backdrop-blur-md rounded-2xl p-4 md:p-5 flex flex-col cursor-pointer transition-all duration-300 border-2 border-white/50 <?php echo e(($paket->direkomendasikan) ? 'shadow-lg hover:shadow-xl' : 'shadow-sm hover:shadow-lg'); ?> hover:border-primary-400 hover:bg-white/80 has-[:checked]:border-primary-700 has-[:checked]:bg-primary-50/90 has-[:checked]:ring-4 has-[:checked]:ring-primary-200 has-[:checked]:-translate-y-1 has-[:checked]:scale-[1.02] has-[:checked]:shadow-[0_20px_40px_-15px_rgba(66,108,60,0.3)]">
                ...
                <div class="pr-8 mb-4 relative z-0">
                    <span class="inline-block px-2 py-0.5 rounded text-[10px] font-bold tracking-wide uppercase mb-2 bg-primary-50 text-primary-700 border border-primary-200/60 shadow-sm transition-colors duration-300 group-has-[:checked]:bg-primary-700 group-has-[:checked]:text-white group-has-[:checked]:border-transparent">
                        <?php echo e($paket->kelas_program); ?>

                    </span>

                    <h3 class="font-bold text-lg text-gray-900 leading-tight transition-colors duration-300 group-has-[:checked]:text-primary-900"><?php echo e($paket->nama_program); ?></h3>

                    <span class="text-xs font-medium text-gray-500 block mt-0.5"><?php echo e($paket->lokasi_belajar); ?></span>
                </div>
                ...
                <div class="mb-4 pb-4 border-b border-gray-100 relative z-0">
                    <div class="flex items-baseline text-gray-900">
                        ...
                        <span class="text-[28px] font-extrabold tracking-tighter ml-1"><?php echo e(number_format($paket->harga ?? $paket->harga, 0, ',', '.')); ?></span>
                    </div>
                </div>
                ...
                <ul class="space-y-1.5 text-xs text-gray-600 flex-1 flex flex-col justify-start relative z-0">
                    <li class="flex items-start">
                        ...
                        <span><strong><?php echo e($paket->pertemuan ?? 8); ?></strong>× Pertemuan</span>
                    </li>
                    <li class="flex items-start">
                        ...
                        <span>Durasi <strong><?php echo e($paket->durasi_belajar ?? 90); ?> Menit</strong> per sesi</span>
                    </li>
                    <li class="flex items-start">
                        ...
                        <span>Maksimal <strong><?php echo e($paket->max_murid ?? 1); ?> Murid</strong></span>
                    </li>
                    <?php if(!empty($paket->deskripsi_program)): ?>
                        <?php $__currentLoopData = explode("\n", $paket->deskripsi_program); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $desc_line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <li class="flex items-start">
                                ...
                                <span><?php echo e(ltrim(trim($desc_line), '- ')); ?></span>
                            </li>
                            <?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.antarmuka.galat-sebaris','data' => ['name' => 'program_id']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'program_id']); ?>
...
<?php /**PATH C:\laragon\www\ruang-les\resources\views/pendaftaran/langkah4-paket.blade.php ENDPATH**/ ?>