...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.tajuk-halaman','data' => ['title' => 'Daftar Nilai','description' => 'Lihat rekam jejak nilai dan pantau terus progres belajar murid secara mendetail.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Daftar Nilai','description' => 'Lihat rekam jejak nilai dan pantau terus progres belajar murid secara mendetail.']); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'primary']); ?><?php echo e($scores->total()); ?> Data Tersedia <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-left border-collapse text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $scores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skor_nilai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-gray-50/50 transition-colors">
                    <td class="px-4 py-3 align-middle">
                        <?php if(isset($skor_nilai->schedule->package)): ?>
                            <span class="text-sm font-semibold text-gray-900"><?php echo e($skor_nilai->schedule->package->nama_program); ?></span>
                        <?php else: ?>
                            <span class="text-sm italic text-gray-500">Tanpa Paket</span>
                        <?php endif; ?>
                    </td>
                    <td class="px-4 py-3 align-middle">
                        <p class="text-sm font-semibold text-gray-900"><?php echo e($skor_nilai->schedule->nama_kelas ?? 'Kelas Terhapus'); ?></p>
                        <p class="text-xs text-gray-500 mt-1"><?php echo e($skor_nilai->schedule->hari ?? '-'); ?>, <?php echo e($skor_nilai->schedule->formatted_time_range ?? '-'); ?></p>
                    </td>
                    <td class="px-4 py-3 align-middle">
                        <div class="flex flex-col gap-1">
                            <p class="text-sm font-semibold text-gray-900" title="Tanggal Pertemuan Kelas">
                                ...
                                <?php echo e(\Carbon\Carbon::parse($skor_nilai->tanggal_penilaian)->format('d M Y')); ?>
                            ...
                            <p class="text-xs text-gray-500" title="Waktu Input Data oleh Mentor">
                                ...
                                <?php echo e($skor_nilai->created_at->format('d M, H:i')); ?>

                            </p>
                        </div>
                    </td>
                    <td class="px-4 py-3 align-middle">
                        <p class="text-sm font-bold text-gray-900"><?php echo e($skor_nilai->student->nama_murid ?? 'Murid Terhapus'); ?></p>
                        <a href="<?php echo e(route('admin.scores.show', $skor_nilai->murid_id)); ?>" class="inline-flex items-center mt-1.5 text-[11px] font-bold text-primary-600 hover:text-primary-800 bg-primary-50 hover:bg-primary-100 border border-primary-100 px-2 py-0.5 rounded transition-colors">
                    ...
                    <td class="px-4 py-3 align-middle">
                        <div class="flex items-center gap-2 mb-1">
                            <?php if (isset($component)) { $__componentOriginal9e0c80b3c4e03c7346eb73cf95f43f4b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9e0c80b3c4e03c7346eb73cf95f43f4b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.antarmuka.lencana','data' => ['color' => 'primary','class' => 'inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold border']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('antarmuka.lencana'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'primary','class' => 'inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold border']); ?>
...
<?php endif; ?>
                        ...
                        <p class="text-sm font-semibold text-gray-900" title="<?php echo e($skor_nilai->materi_nilai); ?>"><?php echo e($skor_nilai->materi_nilai); ?></p>
                    </td>
                    ...
                    <td class="px-4 py-3 align-middle">
                        <p class="text-sm font-semibold text-gray-900"><?php echo e($skor_nilai->schedule->mentor->name ?? 'Sistem'); ?></p>
                    </td>
                    <td class="px-4 py-3 align-middle text-center">
                        <div class="flex items-center justify-center gap-2">
                            <button @click.prevent="$dispatch('open-edit-modal', {
                                id: <?php echo e($skor_nilai->id); ?>,
                                studentName: '<?php echo e(addslashes($skor_nilai->student->nama_murid)); ?>',
                                date: '<?php echo e($skor_nilai->tanggal_penilaian); ?>',
                                tipe_nilai: '<?php echo e($skor_nilai->tipe_nilai); ?>',
                                materi_nilai: '<?php echo e(addslashes($skor_nilai->materi_nilai)); ?>',
                                skor_nilai: '<?php echo e($skor_nilai->skor_nilai); ?>',
                                notes_nilai: '<?php echo e(addslashes($skor_nilai->notes_nilai)); ?>',
                                actionUrl: '<?php echo e(route('admin.scores.update', $skor_nilai->id)); ?>'
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.keadaan-kosong','data' => ['icon' => 'document-text','title' => 'Data Nilai Tidak Ditemukan','message' => 'Tidak ada data nilai yang sesuai dengan filter Anda. Coba sesuaikan rentang tanggal atau atur ulang filter.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'document-text','title' => 'Data Nilai Tidak Ditemukan','message' => 'Tidak ada data nilai yang sesuai dengan filter Anda. Coba sesuaikan rentang tanggal atau atur ulang filter.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <div class="p-4 border-t border-gray-100 bg-gray-50/50">
        <?php echo e($scores->appends(request()->query())->links()); ?>
                    ...
                    <form :action="editData.actionUrl" method="POST" @submit="submitForm" novalidate>
                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6">
                            ...
                            <div class="bg-primary-50/50 p-4 rounded-xl border border-primary-100/50 mb-5">
                                ...
                                <input type="date" name="tanggal_penilaian" x-model="editData.date" max="<?php echo e(date('Y-m-d')); ?>" class="mt-2 block w-full rounded-2xl p-3 border border-gray-200 shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ruang-les\resources\views/admin/nilai/daftar.blade.php ENDPATH**/ ?>