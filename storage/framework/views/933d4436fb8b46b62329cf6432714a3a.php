...
<div>
    <div x-data="{
        ...
        <div x-show="!file" class="space-y-3 text-center pointer-events-none relative z-0 w-full">
            ...
            <div class="flex flex-wrap items-center justify-center text-sm text-gray-700 font-semibold gap-1 text-center">
                <span class="text-primary-600 underline decoration-primary-300 underline-offset-4 whitespace-nowrap">Pilih file</span>
                <span class="text-gray-500 font-normal whitespace-nowrap">atau seret dan lepas ke sini</span>
            </div>
