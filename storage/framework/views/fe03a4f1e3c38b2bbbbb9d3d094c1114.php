        ...
        <div class="px-4 pt-2 pb-6 space-y-1">
            ...
            <div class="border-t border-gray-100 mt-4 pt-4">
                ...
                <?php else: ?>
                    ...
                    <?php if(Auth::user()->role === 'admin'): ?>
                        <a href="<?php echo e(url('/admin/dashboard')); ?>" @click="mobileMenuOpen = false" class="block px-3 py-2 rounded-md text-base font-bold text-primary-700 hover:bg-primary-50">Dashboard Admin</a>
                    <?php elseif(Auth::user()->role === 'mentor'): ?>
                        <a href="<?php echo e(url('/mentor/dashboard')); ?>" @click="mobileMenuOpen = false" class="block px-3 py-2 rounded-md text-base font-bold text-primary-700 hover:bg-primary-50">Dashboard Mentor</a>
                    <?php else: ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" @click="mobileMenuOpen = false" class="block px-3 py-2 rounded-md text-base font-bold text-primary-700 hover:bg-primary-50">Dashboard Orang Tua</a>
                    <?php endif; ?>
