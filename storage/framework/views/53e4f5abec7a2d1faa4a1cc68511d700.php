...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.tajuk-halaman','data' => ['description' => 'Selamat datang di pusat kendali. Berikut adalah ringkasan performa dan aktivitas Ruang Les hari ini.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.kartu-statistik','data' => ['url' => ''.e(route('admin.transactions.index')).'','theme' => 'gradient','color' => 'primary','badgeText' => 'Bulan Ini','title' => 'Pendapatan Masuk','value' => 'Rp '.e(number_format($totalPendapatan, 0, ',', '.')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => ''.e(route('admin.transactions.index')).'','theme' => 'gradient','color' => 'primary','badgeText' => 'Bulan Ini','title' => 'Pendapatan Masuk','value' => 'Rp '.e(number_format($totalPendapatan, 0, ',', '.')).'']); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginalef8e49027d66d5ee542acca573cb2733 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalef8e49027d66d5ee542acca573cb2733 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.kartu-statistik','data' => ['url' => ''.e(route('admin.regist-verifications.index')).'','theme' => 'glass','color' => 'yellow','badgeText' => 'Menunggu','title' => 'Pendaftaran Pending','value' => ''.e($pendingRegistrations).'','unit' => 'antrean']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.kartu-statistik'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => ''.e(route('admin.regist-verifications.index')).'','theme' => 'glass','color' => 'yellow','badgeText' => 'Menunggu','title' => 'Pendaftaran Pending','value' => ''.e($pendingRegistrations).'','unit' => 'antrean']); ?>
         <?php $__env->slot('icon', null, []); ?> 
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginalef8e49027d66d5ee542acca573cb2733 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalef8e49027d66d5ee542acca573cb2733 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.kartu-statistik','data' => ['url' => ''.e(route('admin.transactions.kuota')).'','theme' => 'glass','color' => 'red','badgeText' => 'Kritis (≤ 0)','title' => 'Kuota Murid Habis','value' => ''.e($criticalQuota).'','unit' => 'murid']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.kartu-statistik'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => ''.e(route('admin.transactions.kuota')).'','theme' => 'glass','color' => 'red','badgeText' => 'Kritis (≤ 0)','title' => 'Kuota Murid Habis','value' => ''.e($criticalQuota).'','unit' => 'murid']); ?>
         <?php $__env->slot('icon', null, []); ?> 
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginalef8e49027d66d5ee542acca573cb2733 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalef8e49027d66d5ee542acca573cb2733 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.kartu-statistik','data' => ['url' => ''.e(route('admin.helpdesks.index')).'','theme' => 'glass','color' => 'blue','badgeText' => 'Butuh Balasan','title' => 'Tiket Layanan Baru','value' => ''.e($pendingTickets).'','unit' => 'tiket']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.kartu-statistik'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => ''.e(route('admin.helpdesks.index')).'','theme' => 'glass','color' => 'blue','badgeText' => 'Butuh Balasan','title' => 'Tiket Layanan Baru','value' => ''.e($pendingTickets).'','unit' => 'tiket']); ?>
         <?php $__env->slot('icon', null, []); ?> 
...
<div x-show="mounted" x-transition:enter="transition ease-out duration-500 delay-200" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="flex flex-col space-y-6 mb-8">
    ...
    <div class="bg-white/80 backdrop-blur-md rounded-2xl shadow-sm border border-primary-100/50 overflow-hidden flex flex-col">
        <div class="p-6 border-b border-gray-100 flex items-center justify-between bg-yellow-50/30">
            ...
            <a href="<?php echo e(route('admin.transactions.index')); ?>" class="text-sm font-bold text-primary-600 hover:text-primary-700">Lihat Semua</a>
        </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.avatar','data' => ['name' => $transaction->user->name ?? 'Pengguna','avatarUrl' => $transaction->user->avatar ?? null,'size' => '8','textSize' => 'text-xs']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($transaction->user->name ?? 'Pengguna'),'avatar-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($transaction->user->avatar ?? null),'size' => '8','textSize' => 'text-xs']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                    ...
                                    <div>
                                        <p class="text-sm font-bold text-gray-900"><?php echo e($transaction->user->name ?? 'Tanpa Nama'); ?></p>
                                        <p class="text-xs text-gray-500 mt-1">Murid: <?php echo e($transaction->student->nama_murid ?? '-'); ?></p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 align-middle text-center">
                                <span class="text-sm font-bold text-gray-900">Rp <?php echo e(number_format($transaction->total_pembayaran, 0, ',', '.')); ?></span>
                            </td>
                            <td class="px-6 py-4 align-middle text-center">
                                <p class="text-sm font-semibold text-gray-900"><?php echo e($transaction->created_at->diffForHumans()); ?></p>
                            </td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.keadaan-kosong','data' => ['title' => 'Antrean Bersih','message' => 'Tidak ada pembayaran yang menunggu verifikasi.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Antrean Bersih','message' => 'Tidak ada pembayaran yang menunggu verifikasi.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($schedule->mentor->name ?? 'M'),'avatar-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($schedule->mentor->avatar ?? null),'size' => '8','textSize' => 'text-xs']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala3b0902aa82c25e0a3af1fd64938810c)): ?>
<?php $attributes = $__attributesOriginala3b0902aa82c25e0a3af1fd64938810c; ?>
...
<?php endif; ?>
                                    ...
                                    <div>
                                        <p class="text-sm font-bold text-gray-900"><?php echo e($schedule->mentor->name ?? 'Belum Ada Mentor'); ?></p>
                                        <p class="text-xs text-gray-500 mt-0.5"><?php echo e($schedule->package->nama_program ?? 'Kelas'); ?> • <?php echo e($schedule->formatted_time_range ?? substr($schedule->waktu_belajar, 0, 5)); ?></p>
                                    </div>
                                </div>
                            ...
                            <form action="<?php echo e(route('admin.class-schedules.remind-mentor', $schedule->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <li class="p-0 border-none">
                            <?php if (isset($component)) { $__componentOriginala248761445578b3580e6fcec2c0db260 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala248761445578b3580e6fcec2c0db260 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.keadaan-kosong','data' => ['title' => 'Semua Disiplin','message' => 'Seluruh tugas rutin mentor hari ini sudah tuntas.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.keadaan-kosong'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Semua Disiplin','message' => 'Seluruh tugas rutin mentor hari ini sudah tuntas.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala248761445578b3580e6fcec2c0db260)): ?>
<?php $attributes = $__attributesOriginala248761445578b3580e6fcec2c0db260; ?>
...
<?php endif; ?>
                                    ...
                                    <div>
                                        <p class="text-sm font-bold text-gray-900"><?php echo e($schedule->package->nama_program ?? 'Program Terhapus'); ?></p>
...
<?php endif; ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <li class="p-0 border-none">
                            <?php if (isset($component)) { $__componentOriginala248761445578b3580e6fcec2c0db260 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala248761445578b3580e6fcec2c0db260 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.keadaan-kosong','data' => ['title' => 'Libur','message' => 'Tidak ada jadwal kelas hari ini.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.keadaan-kosong'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Libur','message' => 'Tidak ada jadwal kelas hari ini.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala248761445578b3580e6fcec2c0db260)): ?>
<?php $attributes = $__attributesOriginala248761445578b3580e6fcec2c0db260; ?>
...
<div x-show="mounted" x-transition:enter="transition ease-out duration-500 delay-300" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="bg-white/80 backdrop-blur-md p-6 rounded-2xl shadow-sm border border-primary-100/50 w-full mb-8">
    ...
    <div class="h-64 flex items-end justify-between space-x-2 pt-4">
        <?php $maxCount = max(count($trendData) > 0 ? $trendData : [1]) ?: 1; ?>
        <?php $__currentLoopData = $trendData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <div class="w-full flex flex-col items-center group">
                <div class="w-full <?php echo e($isLast ? 'bg-primary-500 shadow-lg shadow-primary-500/30' : 'bg-primary-100 group-hover:bg-primary-200'); ?> rounded-t-lg transition-colors relative" style="height: <?php echo e($heightPercentage); ?>%;">
                    <div class="absolute -top-8 left-1/2 -translate-x-1/2 bg-gray-800 text-white text-xs py-1 px-2 rounded <?php echo e($isLast ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'); ?> transition-opacity"><?php echo e($count); ?></div>
                </div>
                <span class="text-xs <?php echo e($isLast ? 'text-primary-600' : 'text-gray-400'); ?> mt-2 font-bold"><?php echo e($months[$index]); ?></span>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ruang-les\resources\views/admin/dasbor/utama.blade.php ENDPATH**/ ?>