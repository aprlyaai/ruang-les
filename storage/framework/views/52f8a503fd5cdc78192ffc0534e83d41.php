<?php $__env->startSection('title', 'Pusat Pengumuman'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.tajuk-halaman','data' => ['title' => 'Pusat Pengumuman (Broadcast)','description' => 'Sampaikan pesan atau pengumuman penting ke semua pengguna dalam satu waktu.','actionUrl' => ''.e(route('admin.announcements.create')).'','actionLabel' => 'Buat Pengumuman Baru','icon' => 'megaphone']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Pusat Pengumuman (Broadcast)','description' => 'Sampaikan pesan atau pengumuman penting ke semua pengguna dalam satu waktu.','actionUrl' => ''.e(route('admin.announcements.create')).'','actionLabel' => 'Buat Pengumuman Baru','icon' => 'megaphone']); ?>
            ...
            <table class="w-full text-left border-collapse text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition-colors" data-id="<?php echo e($announcement->id); ?>" x-show="(filter === 'all' || filter === '<?php echo e($announcement->status_pengumuman ? '1' : '0'); ?>') && (search === '' || <?php echo \Illuminate\Support\Js::from(strtolower($announcement->judul_pengumuman ?? ''))->toHtml() ?>.includes(search.toLowerCase()) || <?php echo \Illuminate\Support\Js::from(strtolower(strip_tags($announcement->isi_pengumuman ?? '')))->toHtml() ?>.includes(search.toLowerCase()))" x-transition>
                            <td class="px-4 py-3 align-middle whitespace-nowrap">
                                <div class="text-sm font-semibold text-gray-900"><?php echo e($announcement->created_at->format('d M Y')); ?></div>
                                <div class="text-xs text-gray-500 mt-1"><?php echo e($announcement->created_at->format('H:i')); ?> WIB</div>
                            </td>
                            <td class="px-4 py-3 align-middle">
                                <div class="text-sm font-bold text-gray-900"><?php echo e($announcement->judul_pengumuman); ?></div>
                            </td>
                            <td class="px-4 py-4 align-middle">
                                <div class="text-sm text-gray-900 max-w-3xl leading-relaxed text-justify"><?php echo Str::limit(strip_tags($announcement->isi_pengumuman), 137); ?></div>
                            </td>
                            <td class="px-4 py-3 align-middle whitespace-nowrap">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.antarmuka.lencana','data' => ['color' => 'primary','class' => 'inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold w-fit border']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'primary','class' => 'inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold w-fit border']); ?>
                                    <?php echo e($announcement->target_audience); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.sakelar-status','data' => ['route' => route('admin.announcements.toggle-status', $announcement->id),'isActive' => $announcement->status_pengumuman,'labelActive' => 'Ditayangkan','labelInactive' => 'Diarsipkan']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.announcements.toggle-status', $announcement->id)),'is-active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($announcement->status_pengumuman),'label-active' => 'Ditayangkan','label-inactive' => 'Diarsipkan']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                    <?php if (isset($component)) { $__componentOriginald1e5ba0f948572b366847254c1a63922 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald1e5ba0f948572b366847254c1a63922 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.sakelar-status','data' => ['route' => route('admin.announcements.toggle-status', $announcement->id),'isActive' => $announcement->diprioritaskan,'field' => 'diprioritaskan','labelActive' => 'Disematkan','labelInactive' => 'Disematkan','bgActive' => 'bg-amber-400','textActive' => 'text-amber-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.sakelar-status'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.announcements.toggle-status', $announcement->id)),'is-active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($announcement->diprioritaskan),'field' => 'diprioritaskan','label-active' => 'Disematkan','label-inactive' => 'Disematkan','bg-active' => 'bg-amber-400','text-active' => 'text-amber-600']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald1e5ba0f948572b366847254c1a63922)): ?>
<?php $attributes = $__attributesOriginald1e5ba0f948572b366847254c1a63922; ?>
...
<?php endif; ?>
                            ...
                            <td class="px-4 py-3 align-middle whitespace-nowrap text-center">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="<?php echo e(route('admin.announcements.edit', $announcement->id)); ?>" class="inline-flex items-center p-2 text-sm font-medium text-gray-500 bg-gray-50 rounded-lg hover:bg-gray-100 hover:text-primary-600 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500" title="Edit">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.formulir-hapus','data' => ['route' => route('admin.announcements.destroy', $announcement->id),'itemName' => $announcement->judul_pengumuman]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.announcements.destroy', $announcement->id)),'item-name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($announcement->judul_pengumuman)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.keadaan-kosong','data' => ['title' => 'Belum ada pengumuman','message' => 'Yuk, buat pengumuman pertama untuk membagikan informasi kepada Ruang Les.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Belum ada pengumuman','message' => 'Yuk, buat pengumuman pertama untuk membagikan informasi kepada Ruang Les.']); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ruang-les\resources\views/admin/pengumuman/daftar.blade.php ENDPATH**/ ?>