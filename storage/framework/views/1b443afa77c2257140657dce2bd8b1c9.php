...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['name', 'label', 'model' => null, 'rows' => '4', 'placeholder' => '', 'required' => false, 'value' => '']));
...
foreach (array_filter((['name', 'label', 'model' => null, 'rows' => '4', 'placeholder' => '', 'required' => false, 'value' => '']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div>
    ...
    <textarea name="<?php echo e($name); ?>" id="<?php echo e($name); ?>" rows="<?php echo e($rows); ?>" 
        <?php if($model): ?>
        ...
        placeholder="<?php echo e($placeholder); ?>" <?php echo e($required ? 'required' : ''); ?>><?php echo e($model ? '' : $value); ?></textarea>
...
<?php /**PATH C:\laragon\www\ruang-les\resources\views/components/admin/area-teks-formulir.blade.php ENDPATH**/ ?>