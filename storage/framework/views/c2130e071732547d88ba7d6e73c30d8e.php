...
<?php $component->withAttributes(['color' => 'primary','class' => 'bg-white']); ?>
                                    <svg class="w-5 h-5 transform transition-transform duration-300" :class="activeFaq === <?php echo e($faq->faq_id); ?> ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH C:\laragon\www\ruang-les\resources\views/components/publik/faq.blade.php ENDPATH**/ ?>