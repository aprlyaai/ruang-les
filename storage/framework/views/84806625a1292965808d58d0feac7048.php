        ...
        <div x-show="mounted" x-transition:enter="transition ease-out duration-700" x-transition:enter-start="opacity-0 translate-y-10" x-transition:enter-end="opacity-100 translate-y-0"
            ...
            <div class="p-12 text-center relative z-10 flex flex-col items-center">
                ...
                <p class="text-gray-600 max-w-xl mx-auto text-lg leading-relaxed">
                    Terima kasih telah melakukan pembayaran! Admin kami sedang meninjau dan memverifikasi pendaftaran <strong><?php echo e($activeSiswa->panggilan_murid ?? 'Anak Anda'); ?></strong>. Fitur Ruang Les akan terbuka secara otomatis setelah proses verifikasi selesai.
                </p>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.tajuk-halaman','data' => ['description' => 'Pantau perkembangan dan jadwal belajar '.e($activeSiswa->panggilan_murid).' dengan mudah melalui dashboard ini.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['description' => 'Pantau perkembangan dan jadwal belajar '.e($activeSiswa->panggilan_murid).' dengan mudah melalui dashboard ini.']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.kartu-statistik','data' => ['url' => ''.e(route('ortu.jadwal')).'','theme' => 'gradient','color' => 'primary','badgeText' => 'Kelas '.e($activeSiswa->kelas).' SD','title' => 'Profil Anak','value' => ''.e($activeSiswa->panggilan_murid).'','unit' => ''.e($activeSiswa->sekolah).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => ''.e(route('ortu.jadwal')).'','theme' => 'gradient','color' => 'primary','badgeText' => 'Kelas '.e($activeSiswa->kelas).' SD','title' => 'Profil Anak','value' => ''.e($activeSiswa->panggilan_murid).'','unit' => ''.e($activeSiswa->sekolah).'']); ?>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginalef8e49027d66d5ee542acca573cb2733 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalef8e49027d66d5ee542acca573cb2733 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.kartu-statistik','data' => ['url' => ''.e(route('ortu.tagihan')).'','theme' => 'glass','color' => ''.e(($kuota && $kuota->sisa_sesi <= 2) ? 'red' : 'primary').'','title' => 'Sisa Kuota Sesi','value' => ''.e($kuota ? $kuota->sisa_sesi : 0).'','unit' => 'Sesi dari '.e($kuota ? $kuota->total_sesi : 0).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.kartu-statistik'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => ''.e(route('ortu.tagihan')).'','theme' => 'glass','color' => ''.e(($kuota && $kuota->sisa_sesi <= 2) ? 'red' : 'primary').'','title' => 'Sisa Kuota Sesi','value' => ''.e($kuota ? $kuota->sisa_sesi : 0).'','unit' => 'Sesi dari '.e($kuota ? $kuota->total_sesi : 0).'']); ?>
                 <?php $__env->slot('icon', null, []); ?> 
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                 <?php $__env->endSlot(); ?>
                <?php if($kuota): ?>
                     <?php $__env->slot('badgeText', null, []); ?> 
                        <?php if($kuota->sisa_sesi < 0): ?>
                            Nunggak
                        <?php elseif($kuota->sisa_sesi == 0): ?>
                            Habis
                        <?php elseif($kuota->sisa_sesi <= 2): ?>
                            Hampir Habis
                        <?php endif; ?>
                     <?php $__env->endSlot(); ?>
                <?php endif; ?>
                <div class="mt-4">
                    <div class="flex justify-between text-xs mb-1">
                        ...
                        <span class="font-bold <?php echo e(($kuota && $kuota->sisa_sesi <= 2) ? 'text-red-600' : 'text-primary-600'); ?>"><?php echo e($kuota ? round($kuota->progress_persen) : 0); ?>%</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-1.5 overflow-hidden">
                        <div class="<?php echo e(($kuota && $kuota->sisa_sesi <= 2) ? 'bg-red-500' : 'bg-primary-500'); ?> h-1.5 rounded-full transition-all duration-1000 ease-out" style="width: <?php echo e($kuota ? $kuota->progress_persen : 0); ?>%"></div>
                    </div>
                </div>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginalef8e49027d66d5ee542acca573cb2733 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalef8e49027d66d5ee542acca573cb2733 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.kartu-statistik','data' => ['url' => ''.e(route('ortu.tagihan')).'','theme' => 'glass','color' => ''.e(($kuota && $kuota->sisa_sesi <= 0) ? 'red' : 'primary').'','title' => 'Estimasi Pembayaran','value' => ''.e($kuota && $kuota->estimasi_day_of_week_h ? \Carbon\Carbon::parse($kuota->estimasi_day_of_week_h)->translatedFormat('d F Y, ') : '-').'','unit' => ''.e($kuota && $kuota->estimasi_day_of_week_h ? ' ' . \Carbon\Carbon::parse($kuota->estimasi_day_of_week_h)->translatedFormat('l') : '').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.kartu-statistik'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => ''.e(route('ortu.tagihan')).'','theme' => 'glass','color' => ''.e(($kuota && $kuota->sisa_sesi <= 0) ? 'red' : 'primary').'','title' => 'Estimasi Pembayaran','value' => ''.e($kuota && $kuota->estimasi_day_of_week_h ? \Carbon\Carbon::parse($kuota->estimasi_day_of_week_h)->translatedFormat('d F Y, ') : '-').'','unit' => ''.e($kuota && $kuota->estimasi_day_of_week_h ? ' ' . \Carbon\Carbon::parse($kuota->estimasi_day_of_week_h)->translatedFormat('l') : '').'']); ?>
                 <?php $__env->slot('icon', null, []); ?> 
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                 <?php $__env->endSlot(); ?>
                <?php if($kuota && $kuota->estimasi_day_of_week_h): ?>
                     <?php $__env->slot('badgeText', null, []); ?> 
                        <?php if($kuota->sisa_sesi < 0): ?>
                            Lakukan Pembayaran
                        <?php elseif($kuota->sisa_sesi == 0): ?>
                            Jatuh Tempo
                        <?php else: ?>
                            <?php echo e(\Carbon\Carbon::parse($kuota->estimasi_day_of_week_h)->diffForHumans()); ?>
            ...
            <div class="flex flex-col h-full">
                <div class="bg-white/80 backdrop-blur-md rounded-2xl shadow-sm border border-primary-100/50 overflow-hidden flex flex-col h-full">
                    ...
                    <div class="divide-y divide-gray-100 overflow-y-auto flex-1 max-h-[400px]">
                        ...
                        <div class="p-6 <?php echo e($pengumuman->diprioritaskan ? 'bg-amber-50/30' : 'hover:bg-primary-50/10 transition-colors'); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.antarmuka.lencana','data' => ['color' => 'warning','class' => 'text-[10px] py-0 px-2 group-hover:scale-105 shrink-0 mt-0.5 whitespace-nowrap']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'warning','class' => 'text-[10px] py-0 px-2 group-hover:scale-105 shrink-0 mt-0.5 whitespace-nowrap']); ?>
...
<?php endif; ?>
                                    <?php endif; ?>
                                    <h4 class="font-bold text-gray-900 leading-snug"><?php echo e($pengumuman->judul_pengumuman); ?></h4>
                                </div>
                                <span class="text-xs font-semibold text-gray-500 whitespace-nowrap sm:ml-4"><?php echo e($pengumuman->created_at->format('d M Y')); ?></span>
                            </div>
            ...
            <div class="flex flex-col h-full space-y-6">
                ...
                <div class="bg-white/80 backdrop-blur-md rounded-2xl shadow-sm border border-primary-100/50 overflow-hidden flex flex-col">
                    <div class="p-6 border-b border-gray-100 bg-primary-50/30 flex items-center justify-between">
                        ...
                        <a href="<?php echo e(route('ortu.repositori')); ?>" class="text-sm font-bold text-primary-600 hover:text-primary-700 whitespace-nowrap">Buka Materi</a>
                    </div>
                    ...
                    <div class="p-5">
                        <div class="bg-primary-50 border border-primary-200 rounded-2xl p-4 hover:border-primary-400 transition-colors shadow-sm group">
                            <div class="flex justify-between items-start mb-2.5">
                                <?php if (isset($component)) { $__componentOriginal9e0c80b3c4e03c7346eb73cf95f43f4b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9e0c80b3c4e03c7346eb73cf95f43f4b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.antarmuka.lencana','data' => ['color' => 'primary','class' => 'text-[10px] uppercase tracking-wider group-hover:bg-primary-600 group-hover:text-white transition-colors py-0.5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('antarmuka.lencana'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'primary','class' => 'text-[10px] uppercase tracking-wider group-hover:bg-primary-600 group-hover:text-white transition-colors py-0.5']); ?>
                                    <?php echo e(str_replace('_', ' ', $activePendaftaran->package->tipe_program)); ?>
...
<?php endif; ?>
                            ...
                            <h4 class="text-base font-bold text-gray-900 mb-3"><?php echo e($activePendaftaran->package->nama_program); ?></h4>
                            <div class="space-y-2">
                                <div class="flex justify-between items-center text-xs border-b border-primary-100/50 pb-2">
                                    ...
                                    <span class="font-bold text-gray-900 bg-white px-2 py-0.5 rounded-lg shadow-sm border border-primary-100 text-xs"><?php echo e($activePendaftaran->package->durasi_belajar); ?> Menit</span>
                                </div>
                                <div class="flex justify-between items-center text-xs pt-0.5">
                                    <span class="text-gray-500 font-semibold">Lokasi Belajar:</span>
                                    <span class="font-bold text-gray-900 bg-white px-2 py-0.5 rounded-lg shadow-sm border border-primary-100 text-xs"><?php echo e($activePendaftaran->package->lokasi_belajar); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white/80 backdrop-blur-md rounded-2xl shadow-sm border border-primary-100/50 overflow-hidden flex flex-col flex-1">
                    <div class="p-6 border-b border-gray-100 bg-primary-50/30 flex items-center justify-between">
                        ...
                        <a href="<?php echo e(route('ortu.jadwal')); ?>" class="text-sm font-bold text-primary-600 hover:text-primary-700">Lihat Kalender</a>
                    </div>
                    ...
                    <div class="p-6 space-y-4 overflow-y-auto">
                        ...
                        <?php if($schedulesList->isNotEmpty()): ?>
                            <div class="divide-y divide-gray-100">
                                <?php $__currentLoopData = $schedulesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sched): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between py-3.5 first:pt-0 last:pb-0">
                                    <div>
                                        <span class="font-bold text-gray-900 text-sm block leading-tight"><?php echo e($sched->hari); ?></span>
                                        <span class="text-xs text-primary-600 font-bold block mt-1"><?php echo e($sched->formatted_time_range); ?></span>
                                    </div>
                                    <span class="text-[10px] font-bold text-gray-500 bg-gray-100 px-2.5 py-0.5 rounded border border-gray-200/50 uppercase tracking-wider shrink-0">
                                        <?php echo e($sched->lokasi_belajar); ?>
                        ...
                        <?php else: ?>
                            <div class="flex flex-col items-center justify-center py-8">
                                <?php if (isset($component)) { $__componentOriginala248761445578b3580e6fcec2c0db260 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala248761445578b3580e6fcec2c0db260 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.keadaan-kosong','data' => ['title' => 'Belum Ada Jadwal','message' => 'Jadwal kelas belum ditentukan oleh Admin.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.keadaan-kosong'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Belum Ada Jadwal','message' => 'Jadwal kelas belum ditentukan oleh Admin.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala248761445578b3580e6fcec2c0db260)): ?>
<?php $attributes = $__attributesOriginala248761445578b3580e6fcec2c0db260; ?>
        ...
        <div x-show="mounted" x-transition:enter="transition ease-out duration-500 delay-300" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="mb-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="bg-white/80 backdrop-blur-md rounded-2xl shadow-sm border border-primary-100/50 p-6 flex flex-col">
                    ...
                    <?php if(isset($totalAttendance) && $totalAttendance > 0): ?>
                        <div class="space-y-4 mt-4 flex-1 flex flex-col justify-center">
                            <?php $__currentLoopData = ['Hadir' => ['color' => 'bg-green-500', 'bg' => 'bg-green-100'], 'Tidak Hadir' => ['color' => 'bg-red-500', 'bg' => 'bg-red-100'], 'Libur' => ['color' => 'bg-yellow-500', 'bg' => 'bg-yellow-100']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $theme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div>
                                    <div class="flex justify-between text-sm font-medium mb-1">
                                        <span class="text-gray-700"><?php echo e($status); ?> <span class="text-gray-400 text-xs ml-1">(<?php echo e($count); ?>)</span></span>
                                        <span class="text-gray-900 font-bold"><?php echo e($percent); ?>%</span>
                                    </div>
                                    <div class="w-full <?php echo e($theme['bg']); ?> rounded-full h-2">
                                        <div class="<?php echo e($theme['color']); ?> h-2 rounded-full" style="width: <?php echo e($percent); ?>%"></div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    <?php else: ?>
                        <div class="flex-1 flex items-center justify-center min-h-[200px]">
                            <?php if (isset($component)) { $__componentOriginala248761445578b3580e6fcec2c0db260 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala248761445578b3580e6fcec2c0db260 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.keadaan-kosong','data' => ['title' => 'Belum Ada Data','message' => 'Data presensi belum dimasukkan oleh mentor.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.keadaan-kosong'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Belum Ada Data','message' => 'Data presensi belum dimasukkan oleh mentor.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala248761445578b3580e6fcec2c0db260)): ?>
<?php $attributes = $__attributesOriginala248761445578b3580e6fcec2c0db260; ?>
...
<?php endif; ?>
                ...
                <div class="bg-white/80 backdrop-blur-md rounded-2xl shadow-sm border border-primary-100/50 p-6 flex flex-col">
                    <h3 class="text-lg font-bold text-gray-900 mb-4 border-b border-gray-100 pb-2 flex justify-between items-center">
                        ...
                        <a href="<?php echo e(route('ortu.buku-akademik')); ?>" class="text-sm font-bold text-primary-600 hover:text-primary-700">Lihat Rapot</a>
                    </h3>
                    <?php if(isset($recentScores) && $recentScores->count() > 0): ?>
                        <div class="flex-1 flex items-end justify-between gap-2 mt-4 pt-4 min-h-[200px]">
                            <?php $__currentLoopData = $recentScores->reverse(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $score): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div class="flex flex-col items-center flex-1 group relative">
                                    ...
                                    <div class="opacity-0 group-hover:opacity-100 transition-opacity absolute -top-14 bg-gray-900 text-white text-xs py-1 px-2 rounded pointer-events-none whitespace-nowrap z-10 text-center">
                                        <?php echo e(Str::limit($score->materi_nilai, 15)); ?><br><?php echo e($score->skor_nilai); ?>

                                    </div>
                                    <span class="text-xs font-bold text-gray-700 mb-1"><?php echo e($score->score); ?></span>
                                    <div class="w-full md:w-10 <?php echo e($barColor); ?> rounded-t-sm transition-all duration-700 ease-out hover:opacity-80" style="height: <?php echo e($height); ?>%;"></div>
                                    <span class="text-[10px] text-gray-500 mt-2 truncate w-full text-center"><?php echo e(\Carbon\Carbon::parse($score->tanggal_penilaian)->format('d/m')); ?></span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    <?php else: ?>
                        <div class="flex-1 flex items-center justify-center min-h-[200px]">
                            <?php if (isset($component)) { $__componentOriginala248761445578b3580e6fcec2c0db260 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala248761445578b3580e6fcec2c0db260 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.keadaan-kosong','data' => ['title' => 'Belum Ada Nilai','message' => 'Evaluasi belum dimasukkan oleh mentor.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('admin.keadaan-kosong'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Belum Ada Nilai','message' => 'Evaluasi belum dimasukkan oleh mentor.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginala248761445578b3580e6fcec2c0db260)): ?>
<?php $attributes = $__attributesOriginala248761445578b3580e6fcec2c0db260; ?>
        ...
        <div x-show="mounted" x-transition:enter="transition ease-out duration-500 delay-400" x-transition:enter-start="opacity-0 translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" class="mb-8">
            <div class="bg-gradient-to-r from-gray-900 to-gray-800 rounded-2xl p-5 md:p-6 shadow-xl relative overflow-hidden flex flex-col md:flex-row items-center justify-between">
                ...
                <div class="relative z-10 shrink-0">
                    <a href="<?php echo e(route('ortu.layanan.index')); ?>" class="inline-flex items-center justify-center px-5 py-2.5 border border-transparent text-xs font-bold rounded-xl text-gray-900 bg-white hover:bg-primary-50 hover:text-primary-700 shadow-md shadow-black/20 transition-all transform hover:scale-105">
...
<?php echo $__env->make('layouts.orang-tua', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ruang-les\resources\views/orang-tua/dasbor/utama.blade.php ENDPATH**/ ?>