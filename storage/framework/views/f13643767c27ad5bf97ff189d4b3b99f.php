<?php $__env->startSection('title', 'Repositori Materi'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.tajuk-halaman','data' => ['title' => 'Repositori Materi','description' => 'Atur semua bahan ajar dari catatan sampai video dalam satu ruang terpadu.','actionUrl' => ''.e(route('admin.repository.create')).'','actionLabel' => 'Tambah Materi','icon' => 'add']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Repositori Materi','description' => 'Atur semua bahan ajar dari catatan sampai video dalam satu ruang terpadu.','actionUrl' => ''.e(route('admin.repository.create')).'','actionLabel' => 'Tambah Materi','icon' => 'add']); ?>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 mb-6 mt-6">
    ...
    <div class="p-5">
        <form action="<?php echo e(route('admin.repository.index')); ?>" method="GET">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                ...
                <div>
                    ...
                    <select name="kelas_materi" class="w-full appearance-none rounded-2xl py-3 pl-4 pr-10 border border-gray-200 bg-gray-50 text-sm font-medium text-gray-800 shadow-sm focus:bg-white focus:border-primary-400 focus:ring-2 focus:ring-primary-200 focus:outline-none transition-all duration-150 cursor-pointer bg-[url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%234b5563%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')] bg-[length:1.25rem_1.25rem] bg-[position:right_1rem_center] bg-no-repeat">
                        ...
                        <?php for($i=1; $i<=6; $i++): ?>
                            <option value="<?php echo e($i); ?>" <?php echo e(request('kelas_materi') == $i ? 'selected' : ''); ?>>Kelas <?php echo e($i); ?></option>
                        <?php endfor; ?>
                    </select>
                </div>
                <div>
                    ...
                    <select name="nama_mapel" class="w-full appearance-none rounded-2xl py-3 pl-4 pr-10 border border-gray-200 bg-gray-50 text-sm font-medium text-gray-800 shadow-sm focus:bg-white focus:border-primary-400 focus:ring-2 focus:ring-primary-200 focus:outline-none transition-all duration-150 cursor-pointer bg-[url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%234b5563%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')] bg-[length:1.25rem_1.25rem] bg-[position:right_1rem_center] bg-no-repeat">
                        ...
                        <?php $__currentLoopData = $mapels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($m); ?>" <?php echo e(request('nama_mapel') == $m ? 'selected' : ''); ?>><?php echo e($m); ?></option>
            ...
            <div class="mt-4 flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
                <a href="<?php echo e(route('admin.repository.index')); ?>" class="inline-flex items-center justify-center px-5 py-2.5 text-sm font-bold text-gray-700 transition-all duration-100 bg-white border border-gray-300 rounded-xl hover:bg-gray-100 focus:outline-none">
                    Reset Filter
                </a>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    <td class="px-6 py-4">
                        <div class="text-sm font-bold text-gray-900"><?php echo e($material->nama_materi); ?></div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.antarmuka.lencana','data' => ['color' => 'gray','class' => 'inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold border w-fit']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'gray','class' => 'inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold border w-fit']); ?>
...
<?php endif; ?>
                            ...
                            <span>&bull;</span>
                            <span>Bab: <?php echo e($material->topik_bab); ?></span>
                            <?php endif; ?>
                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm font-semibold text-gray-900">Kelas <?php echo e($material->kelas_materi); ?></div>
                        <div class="text-xs text-primary-600 mt-1"><?php echo e($material->nama_mapel); ?></div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <a href="<?php echo e($material->url_tautan); ?>" target="_blank" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium <?php echo e($material->sumber_tautan == 'YouTube' ? 'bg-red-50 text-red-700 hover:bg-red-100' : ($material->sumber_tautan == 'Google Drive' ? 'bg-blue-50 text-blue-700 hover:bg-blue-100' : 'bg-gray-100 text-gray-700 hover:bg-gray-200')); ?> transition-colors">
                            <?php if($material->sumber_tautan == 'YouTube'): ?>
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                            <?php elseif($material->sumber_tautan == 'Google Drive'): ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-center">
                        <div class="text-xs font-semibold flex items-center justify-start gap-1 <?php echo e($material->hak_akses == 'Publik' ? 'text-gray-600' : ($material->hak_akses == 'Murid' ? 'text-blue-600' : 'text-red-600')); ?>">
                            <?php if($material->hak_akses == 'Publik'): ?>
                            <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                            <?php elseif($material->hak_akses == 'Murid'): ?>
                            ...
                            <?php endif; ?>
                            <?php echo e($material->hak_akses == 'Murid' ? 'Murid' : ($material->hak_akses == 'Mentor' ? 'Mentor' : 'Publik')); ?>

                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-center">
                        <?php if($material->status_materi): ?>
                            <?php if (isset($component)) { $__componentOriginal9e0c80b3c4e03c7346eb73cf95f43f4b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9e0c80b3c4e03c7346eb73cf95f43f4b = $attributes; } ?>
...
<?php endif; ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-center">
                        <span class="text-sm font-semibold text-gray-900"><?php echo e($material->jumlah_klik); ?></span>
                        <span class="text-xs text-gray-500 mt-1 block">Klik</span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex justify-end gap-2">
                            <a href="<?php echo e(route('admin.repository.edit', $material->id)); ?>" class="inline-flex items-center p-1.5 text-gray-500 bg-gray-50 rounded-lg hover:bg-primary-50 hover:text-primary-600 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500" title="Edit">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.formulir-hapus','data' => ['route' => route('admin.repository.destroy', $material->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.repository.destroy', $material->id))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        ...
                        <div class="text-[10px] text-gray-500 mt-0.5">Oleh: <?php echo e($material->uploader->name ?? 'Sistem'); ?></div>
                    </td>
                </tr>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.keadaan-kosong','data' => ['icon' => 'document-text','title' => 'Materi Tidak Ditemukan','message' => 'Belum ada materi belajar yang diunggah atau tidak ada data yang cocok dengan filter Anda.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'document-text','title' => 'Materi Tidak Ditemukan','message' => 'Belum ada materi belajar yang diunggah atau tidak ada data yang cocok dengan filter Anda.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ruang-les\resources\views/admin/repositori/daftar.blade.php ENDPATH**/ ?>