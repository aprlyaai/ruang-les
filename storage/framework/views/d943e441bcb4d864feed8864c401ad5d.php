...
<?php endif; ?>
                ...
                <form method="POST" action="<?php echo e(route('register')); ?>" class="space-y-5" novalidate>
                    ...
                    <!-- Nama Lengkap -->
                    <div x-data="{ errorName: <?php echo e($errors->has('name') ? 'true' : 'false'); ?> }">
                        ...
                        <div class="relative">
                            ...
                            <input id="name" name="name" type="text" required autofocus value="<?php echo e(old('name')); ?>"
                                ...
                                :class="errorName ? 'border-red-300 ring-1 ring-red-300 bg-red-50' : ''">
                        </div>
                        <div x-show="errorName">
...
<?php endif; ?>
                ...
                <div class="mt-10 pt-6 border-t border-gray-200 text-center">
                    <p class="text-sm text-gray-600">
                        Sudah memiliki akun? 
                        <a href="<?php echo e(route('login')); ?>" class="font-bold text-primary-700 hover:text-primary-800 transition-colors ml-1 hover:underline">Masuk di sini</a>
                    </p>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\ruang-les\resources\views/autentikasi/registrasi.blade.php ENDPATH**/ ?>