<?php $__env->startSection('title', 'Kelola Tanya Jawab (FAQ)'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.tajuk-halaman','data' => ['title' => 'Kelola FAQ','description' => 'Atur daftar pertanyaan yang paling sering diajukan orang tua.','actionUrl' => ''.e(route('admin.faqs.create')).'','actionLabel' => 'Tambah FAQ']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Kelola FAQ','description' => 'Atur daftar pertanyaan yang paling sering diajukan orang tua.','actionUrl' => ''.e(route('admin.faqs.create')).'','actionLabel' => 'Tambah FAQ']); ?>
            ...
            <table class="w-full text-left border-collapse text-sm">
                ...
                <tbody id="sortable-table" class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="bg-white hover:bg-gray-50 transition-colors" data-id="<?php echo e($faq->id); ?>">
                            ...
                            <td class="px-4 py-4 align-middle">
                                <div class="text-sm font-bold text-gray-900"><?php echo e($faq->pertanyaan); ?></div>
                            </td>
                            <td class="px-4 py-4 align-middle">
                                <div class="text-sm text-gray-900 max-w-3xl leading-relaxed text-justify"><?php echo e($faq->jawaban); ?></div>
                            </td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.sakelar-status','data' => ['route' => route('admin.faqs.toggle-status', $faq->id),'isActive' => $faq->status_faq]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.faqs.toggle-status', $faq->id)),'is-active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($faq->status_faq)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                            ...
                            <td class="px-4 py-4 align-middle">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="<?php echo e(route('admin.faqs.edit', $faq->id)); ?>" class="inline-flex items-center p-2 text-sm font-medium text-gray-500 bg-gray-50 rounded-lg hover:bg-gray-100 hover:text-primary-600 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500" title="Edit">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.formulir-hapus','data' => ['route' => route('admin.faqs.destroy', $faq->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.faqs.destroy', $faq->id))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.keadaan-kosong','data' => ['title' => 'Belum Ada FAQ','message' => 'Belum ada daftar pertanyaan dan jawaban (FAQ) yang ditambahkan.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Belum Ada FAQ','message' => 'Belum ada daftar pertanyaan dan jawaban (FAQ) yang ditambahkan.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
    ...
    if (el) {
        var sortable = Sortable.create(el, {
            ...
            onEnd: function(evt) {
                ...
                if(orders.length > 0) {
                    fetch('<?php echo e(route('admin.faqs.reorder')); ?>', {
                        method: 'POST',
                        headers: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ruang-les\resources\views/admin/faq/daftar.blade.php ENDPATH**/ ?>