<?php $__env->startSection('title', 'Profil Mentor: ' . $mentor->name); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.tajuk-halaman','data' => ['title' => 'Detail Profil Mentor','backUrl' => ''.e(route('admin.mentor.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Detail Profil Mentor','backUrl' => ''.e(route('admin.mentor.index')).'']); ?>
             <?php $__env->slot('rightActions', null, []); ?> 
                <a href="<?php echo e(route('admin.mentor.edit', ['mentor' => $mentor->id, 'from' => 'detail'])); ?>" class="w-full sm:w-auto px-4 py-2.5 bg-white border border-gray-300 text-gray-700 rounded-xl font-bold text-sm hover:bg-primary-50 hover:text-primary-700 hover:border-primary-300 transition-colors shadow-sm flex items-center justify-center">
                ...
                <form action="<?php echo e(route('admin.mentor.destroy', $mentor->id)); ?>" method="POST" id="deleteForm" class="w-full sm:w-auto">
                    <?php echo csrf_field(); ?>
        ...
        <div class="flex flex-col md:flex-row items-center md:items-center gap-6">
            <div class="flex-shrink-0">
                <?php if($mentor->avatar): ?>
                    <img src="<?php echo e(asset('storage/' . $mentor->avatar)); ?>" alt="Avatar" class="w-20 h-20 md:w-24 md:h-24 rounded-full object-cover shadow-sm bg-gray-50 border border-gray-100">
                <?php else: ?>
                    <div class="w-20 h-20 md:w-24 md:h-24 rounded-full bg-primary-50 border border-primary-100 flex items-center justify-center text-5xl font-extrabold text-primary-700 shadow-sm">
                        <?php echo e(substr($mentor->name, 0, 1)); ?>
            ...
            <div class="flex-grow text-center md:text-left">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        <h2 class="text-2xl md:text-3xl font-extrabold text-gray-900"><?php echo e($mentor->name); ?></h2>
                        <p class="text-primary-600 font-semibold text-base mt-1"><?php echo e(optional($mentor->mentorProfile)->spesialisasi_mentor ?? 'Belum ada spesialisasi'); ?></p>
                    </div>

                    <div>
                        <?php if(optional($mentor->mentorProfile)->status_mentor): ?>
...
<?php endif; ?> Nonaktif
                ...
                <div class="mt-3 flex flex-wrap justify-center md:justify-start gap-4 md:gap-8">
                    <div class="inline-flex items-center px-3 py-1 rounded-xl text-sm font-medium text-gray-600 bg-gray-50 border border-gray-200 w-fit">
                        ...
                        <a href="mailto:<?php echo e($mentor->email); ?>" class="hover:text-primary-700 transition-colors"><?php echo e($mentor->email); ?></a>
                    </div>
                    <div class="inline-flex items-center px-3 py-1 rounded-xl text-sm font-medium text-gray-600 bg-gray-50 border border-gray-200 w-fit">
                        ...
                        ?>
                        <a href="https://wa.me/<?php echo e($wa_phone); ?>" target="_blank" class="hover:text-primary-600 transition-colors"><?php echo e(optional($mentor->mentorProfile)->no_telepon_mentor ?? '-'); ?></a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-6 text-sm">
                    <div>
                        ...
                        <dd class="font-semibold text-gray-900 text-sm">
                            <?php echo e(optional($mentor->mentorProfile)->tempat_lahir_mentor ?? '-'); ?>,
                            <?php echo e(optional($mentor->mentorProfile)->tanggal_lahir_mentor ? \Carbon\Carbon::parse($mentor->mentorProfile->tanggal_lahir_mentor)->format('d M Y') : '-'); ?>
                    ...
                    <div>
                        ...
                        <dd class="font-semibold text-gray-900 text-sm">
                            <?php echo e(optional($mentor->mentorProfile)->jenis_kelamin_mentor ?? '-'); ?>

                        </dd>
                    </div>
                    <div class="md:col-span-2">
                        <dt class="block text-sm text-gray-600 font-semibold mb-1">Latar Belakang Pendidikan</dt>
                        <dd class="font-semibold text-gray-900 text-sm"><?php echo e(optional($mentor->mentorProfile)->pendidikan_mentor ?? '-'); ?></dd>
                    </div>
                    <div class="md:col-span-2">
                        <dt class="block text-sm text-gray-600 font-semibold mb-1">Alamat Lengkap</dt>
                        <dd class="font-semibold text-gray-900 text-sm leading-relaxed"><?php echo e(optional($mentor->mentorProfile)->alamat_mentor ?? '-'); ?></dd>
                    </div>
                </dl>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse text-sm">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <?php $__empty_1 = true; $__currentLoopData = $mentor->jadwals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jadwal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-primary-50/50 transition-colors">
                                    <td class="px-6 py-5 font-bold text-gray-900">
                                        <?php echo e($jadwal->nama_kelas); ?>

                                    </td>
                                    <td class="px-6 py-5">
                                        <p class="text-sm font-semibold text-gray-900 mb-1"><?php echo e(optional($jadwal->package)->nama_program ?? 'Program Belajar Ruang Les'); ?></p>
                                        <?php if (isset($component)) { $__componentOriginal9e0c80b3c4e03c7346eb73cf95f43f4b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9e0c80b3c4e03c7346eb73cf95f43f4b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.antarmuka.lencana','data' => ['color' => 'primary','class' => 'inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold border whitespace-nowrap']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('antarmuka.lencana'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'primary','class' => 'inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold border whitespace-nowrap']); ?>
                                            <?php echo e(optional($jadwal->package)->tipe_program ?? '-'); ?>
...
<?php endif; ?>
                                    ...
                                    <td class="px-6 py-5">
                                        <div class="text-sm text-gray-900 font-semibold flex items-center mb-1">
                                            ...
                                            <span class="whitespace-nowrap"><?php echo e($jadwal->hari); ?>, <?php echo e($jadwal->formatted_time_range); ?></span>
                                        </div>
                                        <div class="text-xs font-medium text-gray-500 flex items-center">
                                            ...
                                            <span class="whitespace-nowrap">Lokasi: <?php echo e(optional($jadwal->package)->lokasi_belajar ?? 'Online'); ?></span>
                                        </div>
                                    </td>
                                    <td class="px-6 py-5 text-center font-semibold text-gray-900">
                                        <?php echo e($jadwal->jumlah_murid ?? 0); ?> / <?php echo e(optional($jadwal->package)->max_murid ?? 6); ?> murid
                                    </td>
                                </tr>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.keadaan-kosong','data' => ['title' => 'Data Kosong','message' => 'Mentor ini belum memiliki penugasan jadwal kelas.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Data Kosong','message' => 'Mentor ini belum memiliki penugasan jadwal kelas.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div class="lg:col-span-1 space-y-4">
            ...
            <div class="bg-gradient-to-br from-primary-600 to-primary-800 rounded-2xl shadow-md border border-primary-500 p-5 text-white relative overflow-hidden">
                ...
                <div class="relative z-10 flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-4xl font-extrabold"><?php echo e($mentor->jadwals->count()); ?> <span class="text-lg font-medium text-primary-200">Kelas</span></div>
                    </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-primary-100/50 p-5">
                ...
                <?php if(optional($mentor->mentorProfile)->nama_bank): ?>
                    <div class="bg-gradient-to-r from-gray-50 to-white p-5 rounded-2xl border border-gray-200 shadow-sm relative overflow-hidden">
                        ...
                        <div class="text-xs font-bold text-primary-600 mb-2 uppercase tracking-widest"><?php echo e($mentor->mentorProfile->nama_bank); ?></div>
                        <div class="font-mono text-xl md:text-2xl font-extrabold text-gray-900 mb-4 tracking-widest drop-shadow-sm"><?php echo e(chunk_split($mentor->mentorProfile->nomor_akun_bank, 4, ' ')); ?></div>

                        <div class="flex flex-col">
                            <span class="text-[10px] text-gray-400 uppercase font-bold tracking-wider mb-0.5">Pemilik Rekening</span>
                            <span class="text-sm font-bold text-gray-800 uppercase"><?php echo e($mentor->mentorProfile->nama_akun_bank); ?></span>
                        </div>
                    </div>
                <?php else: ?>
                    <div class="p-5 bg-amber-50 rounded-2xl border border-amber-200 flex flex-col items-center justify-center text-center">
                        ...
                        <a href="<?php echo e(route('admin.mentor.edit', ['mentor' => $mentor->id, 'from' => 'detail'])); ?>" class="mt-4 px-4 py-2 bg-white text-amber-700 text-xs font-bold rounded-lg border border-amber-200 shadow-sm hover:bg-amber-100 transition-colors">Lengkapi Data</a>
                    </div>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ruang-les\resources\views/admin/mentor/detail.blade.php ENDPATH**/ ?>