<?php $__env->startSection('title', isset($parent) ? 'Edit Wali Murid' : 'Tambah Wali Murid'); ?>

<?php $__env->startSection('breadcrumbs'); ?>
    <svg class="w-3 h-3 mx-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
    <a href="<?php echo e(route('admin.parents.index')); ?>" class="hover:text-primary-600 transition-colors">Data Wali Murid</a>
    <?php if(isset($parent) && request('from') == 'detail'): ?>
        <svg class="w-3 h-3 mx-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
        <a href="<?php echo e(route('admin.parents.show', $parent->id)); ?>" class="hover:text-primary-600 transition-colors">Profil Wali Murid</a>
    <?php endif; ?>
    <svg class="w-3 h-3 mx-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.tajuk-halaman','data' => ['title' => ''.e(isset($parent) ? 'Edit Data Wali Murid' : 'Tambah Wali Murid Baru').'','backUrl' => ''.e((isset($parent) && request('from') == 'detail') ? route('admin.parents.show', $parent->id) : route('admin.parents.index')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e(isset($parent) ? 'Edit Data Wali Murid' : 'Tambah Wali Murid Baru').'','backUrl' => ''.e((isset($parent) && request('from') == 'detail') ? route('admin.parents.show', $parent->id) : route('admin.parents.index')).'']); ?>
...
<?php endif; ?>
    ...
    <!-- Form -->
    <form action="<?php echo e(isset($parent) ? route('admin.parents.update', $parent->id) : route('admin.parents.store')); ?>" method="POST" enctype="multipart/form-data" novalidate
          x-data="{
              name: <?php echo \Illuminate\Support\Js::from((string) old('name', $parent->name ?? ''))->toHtml() ?>,
              email: <?php echo \Illuminate\Support\Js::from((string) old('email', $parent->email ?? ''))->toHtml() ?>,
              phoneNumber: <?php echo \Illuminate\Support\Js::from((string) old('no_telepon_orangtua', $parent->parentProfile->no_telepon_orangtua ?? ''))->toHtml() ?>,
              showPassword: false,
              showPasswordConfirm: false,
              password: '',
              statusHubungan: <?php echo \Illuminate\Support\Js::from((string) old('status_hubungan', $parent->parentProfile->status_hubungan ?? ''))->toHtml() ?>,
              alamatDomisili: <?php echo \Illuminate\Support\Js::from((string) old('alamat_domisili', $parent->parentProfile->alamat_domisili ?? ''))->toHtml() ?>,
              imagePreview: <?php echo \Illuminate\Support\Js::from(isset($parent) && $parent->avatar ? asset('storage/' . $parent->avatar) : '')->toHtml() ?>,
              touched: {},
              ...
              resetForm() {
                  this.name = <?php echo \Illuminate\Support\Js::from((string) old('name', $parent->name ?? ''))->toHtml() ?>;
                  this.email = <?php echo \Illuminate\Support\Js::from((string) old('email', $parent->email ?? ''))->toHtml() ?>;
                  this.phoneNumber = <?php echo \Illuminate\Support\Js::from((string) old('no_telepon_orangtua', $parent->parentProfile->no_telepon_orangtua ?? ''))->toHtml() ?>;
                  this.password = '';
                  this.showPassword = false;
                  this.showPasswordConfirm = false;
                  this.statusHubungan = <?php echo \Illuminate\Support\Js::from((string) old('status_hubungan', $parent->parentProfile->status_hubungan ?? ''))->toHtml() ?>;
                  this.alamatDomisili = <?php echo \Illuminate\Support\Js::from((string) old('alamat_domisili', $parent->parentProfile->alamat_domisili ?? ''))->toHtml() ?>;
                  this.imagePreview = <?php echo \Illuminate\Support\Js::from(isset($parent) && $parent->avatar ? asset('storage/' . $parent->avatar) : '')->toHtml() ?>;
                  this.touched = {};
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-6">
                            <div class="flex-shrink-0">
                                ...
                                <!-- Empty State -->
                                <template x-if="!imagePreview">
                                    <div class="w-20 h-20 rounded-full bg-gray-100 flex items-center justify-center border-4 border-white shadow-sm">
...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="name" x-model="name" placeholder="Masukkan nama lengkap" @blur="touched.name = true" :class="touched.name && name.trim() === '' ? 'border-red-500 focus:ring-red-500 bg-red-50/30' : 'border-gray-200 focus:border-primary-400 bg-gray-50'" class="block w-full rounded-2xl p-3 border shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 transition-colors duration-100 text-sm font-medium text-gray-800" required>
...
<?php endif; ?>
                        ...
                        <div>
                            ...
                            <?php if (isset($component)) { $__componentOriginale4392c51ccef42726141b9bd03684153 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale4392c51ccef42726141b9bd03684153 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.antarmuka.galat-sebaris','data' => ['name' => 'no_telepon_orangtua']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('antarmuka.galat-sebaris'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'no_telepon_orangtua']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale4392c51ccef42726141b9bd03684153)): ?>
<?php $attributes = $__attributesOriginale4392c51ccef42726141b9bd03684153; ?>
...
<?php endif; ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Password <?php echo isset($parent) ? '<span class="text-xs font-normal text-gray-500 ml-1">(Kosongkan jika tidak diubah)</span>' : '<span class="text-red-500">*</span>'; ?></label>
                            <div class="relative">
                                <input :type="showPassword ? 'text' : 'password'" name="password" x-model="password" placeholder="Minimal 8 karakter" @blur="touched.password = true" :class="touched.password && password === '' && !<?php echo e(isset($parent) ? 'true' : 'false'); ?> ? 'border-red-500 focus:ring-red-500 bg-red-50/30' : 'border-gray-200 focus:border-primary-400 bg-gray-50'" class="block w-full rounded-2xl p-3 pr-10 border shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 transition-colors duration-100 text-sm font-medium text-gray-800" <?php echo e(isset($parent) ? '' : 'required'); ?>>
...
<?php endif; ?>
                        ...
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Konfirmasi Password <?php echo isset($parent) ? '' : '<span class="text-red-500">*</span>'; ?></label>
                            <div class="relative">
                                <input :type="showPasswordConfirm ? 'text' : 'password'" name="password_confirmation" placeholder="Ulangi password" class="block w-full rounded-2xl p-3 pr-10 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800" <?php echo e(isset($parent) ? '' : 'required'); ?>>
...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <textarea name="alamat_domisili" x-model="alamatDomisili" rows="5" placeholder="Masukkan alamat lengkap rumah saat ini" @blur="touched.alamatDomisili = true" :class="touched.alamatDomisili && alamatDomisili.trim() === '' ? 'border-red-500 focus:ring-red-500 bg-red-50/30' : 'border-gray-200 focus:border-primary-400 bg-gray-50'" class="block w-full rounded-2xl p-3 border shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 transition-colors duration-100 text-sm font-medium text-gray-800" required></textarea>
...
<?php endif; ?>
        ...
        <div class="flex flex-col-reverse md:flex-row gap-4 mt-8">
            ...
            <button type="submit" class="w-full md:w-2/3 flex items-center justify-center px-8 py-4 text-base font-extrabold text-white transition-all duration-100 bg-primary-600 rounded-2xl hover:bg-primary-700 shadow-lg shadow-primary-500/30 transform hover:-translate-y-1">
                ...
                <?php echo e(isset($parent) ? 'Simpan Perubahan Data Wali Murid' : 'Simpan Data Wali Murid Baru'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ruang-les\resources\views/admin/orang-tua/formulir.blade.php ENDPATH**/ ?>