...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['color' => 'primary','class' => 'whitespace-nowrap']); ?><?php echo e($attendances->total()); ?> Data Tersedia <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
        ...
        <table class="w-full text-left border-collapse text-sm min-w-[700px]">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td class="px-4 py-3 align-middle">
                        <p class="text-sm font-bold text-gray-900 whitespace-nowrap"><?php echo e($log->student->nama_murid ?? 'Murid Terhapus'); ?></p>
                        <a href="<?php echo e(route('admin.attendances.student', $log->murid_id)); ?>" class="inline-flex items-center mt-1.5 text-[11px] font-bold text-primary-600 hover:text-primary-800 bg-primary-50 hover:bg-primary-100 border border-primary-100 px-2 py-0.5 rounded transition-colors whitespace-nowrap">
