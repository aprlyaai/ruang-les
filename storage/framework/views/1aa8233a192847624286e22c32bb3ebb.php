<?php $__env->startSection('title', 'Data Mentor'); ?>

<?php $__env->startSection('breadcrumbs'); ?>
    <svg class="w-3 h-3 mx-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
    <span class="text-gray-800 font-bold">Data Mentor</span>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.tajuk-halaman','data' => ['title' => 'Daftar Mentor Ruang Les','description' => 'Pusat informasi untuk mengenal dan mengelola jajaran pengajar Ruang Les.','actionUrl' => ''.e(route('admin.mentor.create')).'','actionLabel' => 'Tambah Mentor']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Daftar Mentor Ruang Les','description' => 'Pusat informasi untuk mengenal dan mengelola jajaran pengajar Ruang Les.','actionUrl' => ''.e(route('admin.mentor.create')).'','actionLabel' => 'Tambah Mentor']); ?>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-primary-100/50 overflow-hidden" x-data="{ search: '', filter: 'all' }">
        ...
        <div class="p-4 border-b border-gray-100 bg-gray-50/50 flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="relative w-full md:max-w-md">
                ...
                <input x-model="search" type="text" placeholder="Cari nama mentor atau email..." class="block w-full pl-10 pr-3 py-2 border border-gray-200 rounded-xl leading-5 bg-white placeholder-gray-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-primary-200 focus:border-primary-400 sm:text-sm transition-colors duration-100">
            ...
            <table class="w-full text-left border-collapse text-sm">
                <thead>
                    <tr class="bg-gray-50/50 border-b border-primary-100/50">
                        <th class="px-4 py-3 text-xs font-bold text-gray-500 uppercase tracking-wider">Nama Mentor</th>
                        <th class="px-4 py-3 text-xs font-bold text-gray-500 uppercase tracking-wider">Kontak</th>
                        <th class="px-4 py-3 text-xs font-bold text-gray-500 uppercase tracking-wider">Jumlah Kelas</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $mentors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mentor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition-colors" x-show="(filter === 'all' || filter === '<?php echo e(optional($mentor->mentorProfile)->status_mentor ? '1' : '0'); ?>') && (search === '' || <?php echo \Illuminate\Support\Js::from(strtolower($mentor->name ?? ''))->toHtml() ?>.includes(search.toLowerCase()) || <?php echo \Illuminate\Support\Js::from(strtolower($mentor->email ?? ''))->toHtml() ?>.includes(search.toLowerCase()))" x-transition>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.avatar','data' => ['name' => $mentor->name,'avatarUrl' => $mentor->avatar]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($mentor->name),'avatar-url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($mentor->avatar)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-bold text-gray-900"><?php echo e($mentor->name); ?></div>
                                        <div class="text-xs text-gray-500 mt-1"><?php echo e($mentor->mentorProfile->spesialisasi_mentor ?? 'Belum ada spesialisasi'); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-4 py-3 align-middle">
                                <div class="text-sm text-gray-900 flex items-center">
                                    ...
                                    <span class="truncate"><?php echo e($mentor->email); ?></span>
                                </div>
                                <div class="text-xs text-gray-500 flex items-center mt-1">
                                    ...
                                    <span class="whitespace-nowrap"><?php echo e($mentor->mentorProfile->no_telepon_mentor ?? '-'); ?></span>
                                </div>
                            </td>
                            <td class="px-4 py-3 align-middle">
...
<?php $component->withAttributes(['color' => 'primary','class' => 'inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold border w-fit whitespace-nowrap']); ?>
                                    <?php echo e($mentor->jadwals_count); ?> Kelas
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php $component->withAttributes(['color' => 'primary','class' => 'inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold border w-fit whitespace-nowrap']); ?>
                                        <span class="w-1.5 h-1.5 rounded-full bg-primary-500 mr-1.5 shrink-0"></span> Aktif
                                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9e0c80b3c4e03c7346eb73cf95f43f4b)): ?>
<?php $attributes = $__attributesOriginal9e0c80b3c4e03c7346eb73cf95f43f4b; ?>
...
<?php $component->withAttributes(['color' => 'gray','class' => 'inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold border w-fit whitespace-nowrap']); ?>
                                        <span class="w-1.5 h-1.5 rounded-full bg-gray-400 mr-1.5 shrink-0"></span> Nonaktif
                                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9e0c80b3c4e03c7346eb73cf95f43f4b)): ?>
<?php $attributes = $__attributesOriginal9e0c80b3c4e03c7346eb73cf95f43f4b; ?>
...
<?php endif; ?>
                            ...
                            <td class="px-4 py-3 align-middle">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="<?php echo e(route('admin.mentor.show', $mentor->id)); ?>" class="inline-flex items-center p-2 text-sm font-medium text-gray-500 bg-gray-50 rounded-lg hover:bg-gray-100 hover:text-primary-600 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500" title="Lihat Profil Mentor">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                                    </a>
                                    <a href="<?php echo e(route('admin.mentor.edit', $mentor->id)); ?>" class="inline-flex items-center p-2 text-sm font-medium text-gray-500 bg-gray-50 rounded-lg hover:bg-gray-100 hover:text-primary-600 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500" title="Edit">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.formulir-hapus','data' => ['route' => route('admin.mentor.destroy', $mentor->id),'itemName' => $mentor->name]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.mentor.destroy', $mentor->id)),'item-name' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($mentor->name)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.keadaan-kosong','data' => ['title' => 'Belum Ada Mentor','message' => 'Saat ini belum ada mentor yang bergabung maupun ditambahkan.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Belum Ada Mentor','message' => 'Saat ini belum ada mentor yang bergabung maupun ditambahkan.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
    ...
    document.querySelectorAll('.delete-form').forEach(form => {
        form.addEventListener('submit', function(e) {
            ...
            Swal.fire({
                ...
                text: "Semua data profil dan akses login mentor " + itemName + " ini akan terhapus secara permanen! Jadwal kelas yang terikat dengan mentor ini mungkin akan terdampak.",
                icon: 'warning',
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ruang-les\resources\views/admin/mentor/daftar.blade.php ENDPATH**/ ?>