...
@section('title', 'Pengaturan Konten Landing Page')
...
<div class="w-full" x-data="{
    ...
    <div class="mb-6">
        <x-admin.tajuk-halaman
            title="Content Management System (CMS) Ruang Les"
            description="Waktunya berkreasi! Rancang website semenarik mungkin untuk memikat hati para orang tua dan buah hatinya ❤️"
        >
            <x-slot name="rightActions">
                <a href="{{ url('/') }}" target="_blank" class="group relative inline-flex items-center justify-center px-6 py-2.5 rounded-xl font-bold text-white overflow-hidden shadow-[0_4px_15px_rgba(147,195,139,0.4)] hover:shadow-[0_8px_25px_rgba(147,195,139,0.6)] transition-all duration-300 hover:-translate-y-1">
    ...
    <div class="bg-white/90 backdrop-blur-md rounded-b-2xl shadow-sm border border-primary-100/50 p-6 md:p-8 border-t-0">
        <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data" @reset="$dispatch('form-reset')">
            @csrf
            ...
            <div x-show="activeTab === 'hero'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0" style="display: none;">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 h-fit">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="bimbel_name" value="{{ $settings['bimbel_name'] ?? 'Ruang Les' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                            </div>
                            <div>
                                <div x-data="{ imageUrl: '{{ isset($settings['logo_utama']) ? (str_starts_with($settings['logo_utama'], 'images/') ? asset($settings['logo_utama']) : asset('storage/' . $settings['logo_utama'])) : '' }}', originalUrl: '{{ isset($settings['logo_utama']) ? (str_starts_with($settings['logo_utama'], 'images/') ? asset($settings['logo_utama']) : asset('storage/' . $settings['logo_utama'])) : '' }}' }" @form-reset.window="imageUrl = originalUrl">
                            ...
                            <div>
                                <div x-data="{ imageUrl: '{{ isset($settings['favicon']) ? (str_starts_with($settings['favicon'], 'images/') ? asset($settings['favicon']) : asset('storage/' . $settings['favicon'])) : '' }}', originalUrl: '{{ isset($settings['favicon']) ? (str_starts_with($settings['favicon'], 'images/') ? asset($settings['favicon']) : asset('storage/' . $settings['favicon'])) : '' }}' }" @form-reset.window="imageUrl = originalUrl">
                    ...
                    <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200 h-fit">
                        <div x-data="{ imageUrl: '{{ isset($settings['hero_image']) ? (str_starts_with($settings['hero_image'], 'images/') ? asset($settings['hero_image']) : asset('storage/' . $settings['hero_image'])) : '' }}', originalUrl: '{{ isset($settings['hero_image']) ? (str_starts_with($settings['hero_image'], 'images/') ? asset($settings['hero_image']) : asset('storage/' . $settings['hero_image'])) : '' }}' }" @form-reset.window="imageUrl = originalUrl">
                            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="hero_label" value="{{ $settings['hero_label'] ?? 'Solusi Edukasi Modern' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                        </div>
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Headline Judul</label>
                            <textarea name="hero_headline" rows="2" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ $settings['hero_headline'] ?? "Tingkatkan Prestasi Anak
Bersama Ruang Les" }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Deskripsi</label>
                            <textarea name="hero_description" rows="3" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ $settings['hero_description'] ?? 'Platform bimbingan belajar inovatif untuk siswa Sekolah Dasar (SD). Pantau perkembangan secara transparan, pilih jadwal fleksibel, dan dukung masa depan cerah buah hati Anda dengan metode belajar yang menyenangkan.' }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="hero_cta_button" value="{{ $settings['hero_cta_button'] ?? '' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                            </div>
                            <div>
                                <label class="block text-sm text-gray-600 font-semibold mb-2">Tombol CTA 2</label>
                                <input type="text" name="hero_secondary_button" value="{{ $settings['hero_secondary_button'] ?? '' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="hero_badge_text_1" value="{{ $settings['hero_badge_text_1'] ?? '' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                            </div>
                            <div>
                                <label class="block text-sm text-gray-600 font-semibold mb-2">Badge Melayang Bawah (Skor)</label>
                                <input type="text" name="hero_badge_text_2" value="{{ $settings['hero_badge_text_2'] ?? '' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div x-show="activeTab === 'fitur'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0" style="display: none;">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-6">
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Label Kategori</label>
                            <input type="text" name="features_label" value="{{ $settings['features_label'] ?? 'Kenapa Memilih Kami?' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                        </div>
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Headline Judul</label>
                            <textarea name="features_headline" rows="2" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ $settings['features_headline'] ?? 'Belajar Lebih Dekat, Pantau Lebih Mudah' }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Deskripsi</label>
                            <textarea name="features_description" rows="3" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ $settings['features_description'] ?? 'Anak butuh mentor yang sabar, dan orang tua butuh kepastian. Di Ruang Les, anak Anda mendapat bimbingan yang nyaman, sementara Anda bisa memantau perkembangannya kapan saja secara online.' }}</textarea>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="bg-primary-50/40 p-5 rounded-2xl border border-primary-100 shadow-sm">
                            ...
                            <a href="{{ route('admin.features.index') }}" class="inline-flex items-center justify-center w-full px-4 py-2.5 bg-white border border-primary-200 text-primary-700 rounded-xl text-sm font-bold hover:bg-primary-100 hover:border-primary-300 transition-all shadow-sm group">
                                Kelola Daftar Fitur
            ...
            <div x-show="activeTab === 'program'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0" style="display: none;">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-6">
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Label Kategori</label>
                            <input type="text" name="program_label" value="{{ $settings['program_label'] ?? 'Program Unggulan' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                        </div>
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Headline Judul</label>
                            <textarea name="program_headline" rows="2" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ $settings['program_headline'] ?? 'Pilihan Program Belajar' }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Deskripsi</label>
                            <textarea name="program_description" rows="3" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ $settings['program_description'] ?? 'Kami menyediakan program yang disesuaikan dengan kebutuhan fokus dan gaya belajar anak Anda.' }}</textarea>
                        </div>
                    </div>
                    <div class="space-y-6">
                        <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200">
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Teks Badge di Kartu Program</label>
                            <input type="text" name="program_popular_badge" value="{{ $settings['program_popular_badge'] ?? 'Paling Diminati' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                        ...
                        <div class="bg-primary-50 border border-primary-100 p-5 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-4">
                            ...
                            <a href="{{ route('admin.packages.index') }}" class="shrink-0 inline-flex items-center justify-center px-4 py-2 bg-white border border-primary-200 rounded-xl text-sm font-bold text-primary-700 hover:bg-primary-50 transition-colors shadow-sm">
                                Ke Master Paket
            ...
            <div x-show="activeTab === 'testimoni'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0" style="display: none;">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-6">
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Label Kategori</label>
                            <input type="text" name="testimoni_label" value="{{ $settings['testimoni_label'] ?? 'Kisah Sukses' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                        </div>
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Headline Judul</label>
                            <textarea name="testimoni_headline" rows="2" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ $settings['testimoni_headline'] ?? 'Kata Mereka Tentang Ruang Les' }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Deskripsi</label>
                            <textarea name="testimoni_description" rows="3" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ $settings['testimoni_description'] ?? 'Bergabunglah dengan ratusan orang tua yang telah mempercayakan perkembangan akademik anaknya kepada kami.' }}</textarea>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="bg-primary-50/40 p-5 rounded-2xl border border-primary-100 shadow-sm">
                            ...
                            <a href="{{ route('admin.testimonials.index') }}" class="inline-flex items-center justify-center w-full px-4 py-2.5 bg-white border border-primary-200 text-primary-700 rounded-xl text-sm font-bold hover:bg-primary-100 hover:border-primary-300 transition-all shadow-sm group">
            ...
            <div x-show="activeTab === 'faq'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0" style="display: none;">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-6">
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Label Kategori</label>
                            <input type="text" name="faq_label" value="{{ $settings['faq_label'] ?? 'Pusat Bantuan' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                        </div>
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Headline Judul</label>
                            <textarea name="faq_headline" rows="2" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ $settings['faq_headline'] ?? 'Pertanyaan yang Sering Diajukan' }}</textarea>
                        </div>
                        ...
                        <div class="pt-4 border-t border-dashed border-gray-200 mt-4 space-y-5">
                            ...
                            <div>
                                ...
                                <textarea name="faq_cta_headline" rows="2" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ $settings['faq_cta_headline'] ?? 'Masih punya pertanyaan?' }}</textarea>
                            </div>
                            <div>
                                <label class="block text-sm text-gray-600 font-semibold mb-2">Deskripsi</label>
                                <textarea name="faq_cta_description" rows="2" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ $settings['faq_cta_description'] ?? 'Tim layanan pelanggan kami siap membantu Anda kapan saja. Jangan ragu untuk menghubungi kami.' }}</textarea>
                            </div>
                            <div>
                                <label class="block text-sm text-gray-600 font-semibold mb-2">Tombol CTA</label>
                                <input type="text" name="faq_cta_button" value="{{ $settings['faq_cta_button'] ?? 'Hubungi Kami Sekarang' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="bg-primary-50/40 p-5 rounded-2xl border border-primary-100 shadow-sm">
                            ...
                            <a href="{{ route('admin.faqs.index') }}" class="inline-flex items-center justify-center w-full px-4 py-2.5 bg-white border border-primary-200 text-primary-700 rounded-xl text-sm font-bold hover:bg-primary-100 hover:border-primary-300 transition-all shadow-sm group">
                                Kelola Daftar FAQ
                                <svg class="w-4 h-4 ml-1.5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                            </a>
                        </div>
            ...
            <div x-show="activeTab === 'profil'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0" style="display: none;">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-6">
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Label Kategori</label>
                            <input type="text" name="about_label" value="{{ $settings['about_label'] ?? 'Mengenal Kami' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                        </div>
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Headline Judul</label>
                            <textarea name="about_headline" rows="2" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ str_replace(['<br>', '<br/>', '<br />'], "\n", $settings['about_headline'] ?? "Belajar dengan Hati,\nTumbuh dengan Percaya Diri") }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Deskripsi</label>
                            <textarea name="about_us" rows="7" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ $settings['about_us'] ?? '' }}</textarea>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm text-gray-600 font-semibold mb-2">Visi</label>
                                <textarea name="visi" rows="5" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ $settings['visi'] ?? 'Menjadi platform digital dan mitra terpercaya bagi orang tua dalam mendampingi tumbuh kembang akademik serta pembentukan karakter anak secara holistik.' }}</textarea>
                            </div>
                            <div>
                                <label class="block text-sm text-gray-600 font-semibold mb-2">Misi</label>
                                <textarea name="misi" rows="5" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ $settings['misi'] ?? 'Memberikan pendampingan belajar yang personal dan disesuaikan dengan kebutuhan unik setiap murid.\nMenyediakan laporan perkembangan berkala secara transparan demi menjalin komunikasi terbuka dengan orang tua.\nMembangun lingkungan belajar yang aman, nyaman, dan menumbuhkan rasa cinta belajar sejak dini.' }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200">
                            ...
                            <div class="space-y-6">
                                <div>
                                    ...
                                    <input type="text" name="founder_name" value="{{ $settings['founder_name'] ?? 'Ismaturrohmah, S.Pd., Gr.' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                                </div>
                                <div>
                                    <label class="block text-sm text-gray-600 font-semibold mb-2">Jabatan</label>
                                    <input type="text" name="founder_role" value="{{ $settings['founder_role'] ?? 'Founder' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                                </div>
                                <div>
                                    <div x-data="{ imageUrl: '{{ isset($settings['founder_image']) ? asset($settings['founder_image']) : '' }}', originalUrl: '{{ isset($settings['founder_image']) ? asset($settings['founder_image']) : '' }}' }" @form-reset.window="imageUrl = originalUrl">
            ...
            <div x-show="activeTab === 'galeri'" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform translate-y-4" x-transition:enter-end="opacity-100 transform translate-y-0" style="display: none;">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-6">
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Label Kategori</label>
                            <input type="text" name="gallery_label" value="{{ $settings['gallery_label'] ?? 'Galeri Dokumentasi' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                        </div>
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Headline Judul</label>
                            <textarea name="gallery_headline" rows="2" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ $settings['gallery_headline'] ?? 'Momen Berharga di Ruang Les' }}</textarea>
                        </div>
                        <div>
                            <label class="block text-sm text-gray-600 font-semibold mb-2">Deskripsi</label>
                            <textarea name="gallery_description" rows="4" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ $settings['gallery_description'] ?? 'Sekilas gambaran suasana belajar yang interaktif, hangat, dan menyenangkan.' }}</textarea>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="bg-primary-50/40 p-5 rounded-2xl border border-primary-100 shadow-sm">
                            ...
                            <a href="{{ route('admin.galleries.index') }}" class="inline-flex items-center justify-center w-full px-4 py-2.5 bg-white border border-primary-200 text-primary-700 rounded-xl text-sm font-bold hover:bg-primary-100 hover:border-primary-300 transition-all shadow-sm group">
                                Kelola Galeri Foto
                                <svg class="w-4 h-4 ml-1.5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
                            </a>
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-6">
                        <div>
                            ...
                            <textarea name="footer_description" rows="4" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ $settings['footer_description'] ?? 'Bimbingan belajar terpadu untuk tingkat Sekolah Dasar (SD). Memfasilitasi perkembangan akademik anak dengan pendekatan modern dan transparan, memadukan peran aktif Mentor dan Orang Tua.' }}</textarea>
                        </div>
                        ...
                        <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200">
                            ...
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <input type="text" name="footer_address" value="{{ $settings['footer_address'] ?? 'Jl. H. Shibi No.57, RT.8/RW.001, Srengseng Sawah, Kec. Jagakarsa, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12640' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                                </div>
                                <div>
                                    <label class="block text-sm text-gray-600 font-semibold mb-2">Link URL Google Maps</label>
                                    <input type="text" name="footer_maps_url" value="{{ $settings['footer_maps_url'] ?? 'https://maps.app.goo.gl/3Q' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors placeholder-gray-400 text-sm font-medium" placeholder="https://maps.app.goo.gl/...">
                                </div>
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-sm text-gray-600 font-semibold mb-2">Alamat Email Resmi</label>
                                        <input type="email" name="footer_email" value="{{ $settings['footer_email'] ?? 'ruanglesismaturrohmah@gmail.com' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                                    </div>
                                    <div>
                                        <label class="block text-sm text-gray-600 font-semibold mb-2">Nomor Telepon Resmi</label>
                                        <input type="text" name="footer_whatsapp" value="{{ $settings['footer_whatsapp'] ?? '6281319076124' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-gray-50 p-6 rounded-2xl border border-gray-200">
                            ...
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <input type="text" name="cta_headline" value="{{ $settings['cta_headline'] ?? 'Siap Memulai Perjalanan Belajar Anak Anda?' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                                </div>
                                <div>
                                    <label class="block text-sm text-gray-600 font-semibold mb-2">Deskripsi Banner</label>
                                    <textarea name="cta_description" rows="3" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">{{ $settings['cta_description'] ?? 'Bergabunglah bersama ratusan orang tua lainnya yang telah mempercayakan pendidikan karakter dan akademik putra-putrinya di Ruang Les.' }}</textarea>
                                </div>
                                <div>
                            ...
                            <div class="space-y-5">
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="nama_bank" value="{{ $settings['nama_bank'] ?? 'Bank Central Asia (BCA)' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                                    </div>
                                    <div>
                                        <label class="block text-sm text-gray-600 font-semibold mb-2">Nomor Rekening</label>
                                        <input type="text" name="nomor_akun_bank" value="{{ $settings['nomor_akun_bank'] ?? '7340033447' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800 font-mono">
                                    </div>
                                </div>
                                <div>
                                    <label class="block text-sm text-gray-600 font-semibold mb-2">Nama Pemilik Rekening</label>
                                    <input type="text" name="nama_akun_bank" value="{{ $settings['nama_akun_bank'] ?? 'Ismaturrohmah' }}" class="block w-full rounded-2xl p-3 border border-gray-200 bg-gray-50 shadow-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-400 transition-colors duration-100 text-sm font-medium text-gray-800">
                                </div>
                            </div>
                        </div>
