...
class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="p-5 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
        ...
        <x-antarmuka.lencana color="primary">{{ $scores->total() }} Data Tersedia</x-antarmuka.lencana>
    </div>
        ...
        <table class="w-full text-left border-collapse text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td class="px-4 py-3 align-middle">
                        <p class="text-sm font-bold text-gray-900">{{ $skor_nilai->student->nama_murid ?? 'Murid Terhapus' }}</p>
                        <a href="{{ route('admin.scores.show', $skor_nilai->murid_id) }}" class="inline-flex items-center mt-1.5 text-[11px] font-bold text-primary-600 hover:text-primary-800 bg-primary-50 hover:bg-primary-100 border border-primary-100 px-2 py-0.5 rounded transition-colors">
