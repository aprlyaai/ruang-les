...
@section('title', 'Paket Program Belajar')
...
<div class="space-y-6">
    ...
    <x-admin.tajuk-halaman
        title="Daftar Paket Program Belajar Ruang Les"
        description="Rancang dan tawarkan berbagai pilihan program belajar terbaik untuk murid Ruang Les."
                        ...
                        <tr class="bg-white hover:bg-gray-50 transition-colors" data-id="{{ $package->id }}">
                            ...
                            <td class="px-4 py-3 align-middle">
                                <div class="space-y-3">
                                    ...
                                    <x-admin.sakelar-status
                                        :route="route('admin.packages.toggle-status', $package->id)"
                                        :is-active="$package->direkomendasikan"
                                        field="direkomendasikan"
                                        label-active="Rekomendasi"
                                        label-inactive="Rekomendasi"
                            ...
                            <td class="px-4 py-3 align-middle">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="{{ route('admin.packages.edit', $package->id) }}" class="inline-flex items-center p-2 text-sm font-medium text-gray-500 bg-gray-50 rounded-lg hover:bg-gray-100 hover:text-primary-600 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500" title="Edit">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                    </a>
                                    <x-admin.formulir-hapus :route="route('admin.packages.destroy', $package->id)" :item-name="$package->nama_program" />
                                </div>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-12 align-middle">
                                <x-admin.keadaan-kosong
                                    title="Belum Ada Paket Program Belajar"
                                    message="Saat ini belum ada data paket program belajar di Ruang Les yang ditambahkan."
                                />
                            </td>
                        </tr>
                    @endforelse
