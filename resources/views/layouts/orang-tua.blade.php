...
<head>
    ...
    <title>@yield('title', 'Panel Orang Tua') - Ruang Les</title>
...
<body class="bg-primary-50 text-gray-600 font-sans antialiased text-sm overflow-hidden relative leading-relaxed">
    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen overflow-hidden relative z-10 p-2 sm:p-4 gap-4">
        ...
        <!-- Sidebar Component -->
        <x-orang-tua.bilah-samping :isLocked="$isLocked" />

        <!-- Main Wrapper -->
        <div class="flex-1 flex flex-col h-full overflow-hidden relative">
            <!-- Header Component -->
            <x-orang-tua.tajuk
                :layoutSiswas="$layoutSiswas"
                :layoutActiveSiswaId="$layoutActiveSiswaId"
                :isLocked="$isLocked"
            />
