    ...
    <div class="flex items-center space-x-4">
        ...
        <div x-data="{ dropdownOpen: false }" class="relative">
            ...
            <div x-show="dropdownOpen" 
                ...
                <a href="{{ route('admin.profile.index') }}" class="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50 hover:text-primary-600 font-medium transition-colors group">
